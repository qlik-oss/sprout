...
import { Menu, Skeleton, classNames } from "@qlik/sprout-react";
import type {
  CellContext,
  HeaderContext,
  SortingFnOption,
...
export function useTanStackColumns<ContentType>(
  ...
  return useMemo(() => {
              ...
              <TableHTML.Selection
                ...
                onChange={
                  rowSelectionMode === "multiple"
                    ? info.table.getToggleAllRowsSelectedHandler()
                    : undefined
                }
      ...
      if (column.sortComparator) {
        if (typeof column.sortComparator === "function") {
          ...
          sortingFn = (a, b, columnId) =>
            sortComparatorFn(a.original, b.original, columnId);
        } else {
    ...
    rowSelectAll,
    onCellClick,
  ]) as Array<TanStackColumnDef<ContentType>>;
}
