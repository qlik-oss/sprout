...
import { SegmentedControl, classNames } from "@qlik/sprout-react";
import type { Meta, StoryObj } from "@storybook/react-vite";

import { SegmentedControlGroupArgTypes, SegmentedControlSegmentArgTypes } from "./SegmentedControl.argTypes";
...
export const Segment: StorySegment = {
  render: (props) => (
    <div className={classNames("flex", "w-full", "gap-3xl")} data-testid="wrapper">
