...
<Meta title="table/Rows/Row toggling" />
...
<strong>ℹ️ Note:</strong> When implementing fully controlled mode, developers
should follow and respect [Table
specification](https://internal.qlik.dev/design/sprout/components/table/), the
