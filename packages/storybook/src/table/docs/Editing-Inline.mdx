...
<Meta title="table/Editing/InlineEdit" />
...
```tsx
import { Table, TableInlineEdit } from "@qlik/sprout-react-table";
...
```tsx
import { TableCellParams, editUtility } from "@qlik/sprout-react-table";
