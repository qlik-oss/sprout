...
export const TableArgTypes: ArgTypes = {
  variant: {
    ...
    options: ["data", "list"],
    description:
      "The variant of the table. 'data' is for data tables, 'list' is for list tables.",
    table: {
      type: {
        summary: "data | list",
      },
  ...
  rows: {
    control: "object",
    description:
      "The rows of the table. Can be an array of objects or a function that returns an array.",
    table: {
      type: {
        summary: "ContentType[]",
      },
  ...
  columns: {
    control: "object",
    description:
      "The columns of the table. Can be an array of objects or a function that returns an array.",
    table: {
      type: {
  ...
  rowActions: {
    control: false,
    description:
      "Function that returns the row actions for each row. Used to render actions in the row.",
    table: {
      type: {
  ...
  onRowClick: {
    control: false,
    description:
      "Callback function that is called when a row is clicked. Receives the event and the row data.",
    table: {
      type: {
        summary:
          "(event: MouseEvent<HTMLDivElement>, row: ContentType) => void",
      },
    },
  },
  loading: {
...
export const SortArgTypes: ArgTypes = {
  ...
  defaultSorting: {
    control: "object",
    description:
      "The initial sorting state of the table. An array of objects with 'id' and 'desc' properties.",
    table: {
      type: {
  ...
  sorting: {
    control: "object",
    description:
      "The current sorting state of the table. An array of objects with 'id' and 'desc' properties.",
    table: {
      type: {
        summary: "SortingState",
      },
...
export const RowSelectionArgTypes: ArgTypes = {
  ...
  rowSelection: {
    control: false,
    description:
      "The row selection state. Object with row IDs as keys and boolean values.",
    table: {
      type: {
  ...
  onRowSelectionChange: {
    control: false,
    description:
      "Callback function that is called when the row selection state changes.",
    table: {
      type: {
...
export const RowTogglingArgTypes: ArgTypes = {
  defaultToggledRowId: {
    control: "text",
    description:
      "The id of the initial toggled row. If set, the row will highlighted.",
    table: {
      type: {
        summary: "string",
      },
  ...
  toggledRowId: {
    control: "text",
    description:
      "The controlled id of the toggled row. If set, the row will be highlighted.",
    table: {
      type: {
        summary: "string",
      },
...
export const DataTableRownumberArgTypes: ArgTypes = {
  displayRowNumberColumn: {
    control: "boolean",
    description:
      "Show row numbers in the first column (only for 'data' variant)",
  },
};
...
export const ColumnSelectionArgTypes: ArgTypes = {
  ...
  defaultColumnSelection: {
    control: "text",
    description:
      "The default column selection state. The id of the selected column.",
  },
  onColumnSelectionChange: {
    control: false,
    description:
      "Callback function that is called when the column selection state changes.",
    table: {
      type: {
  ...
  onColumnsSelectionChange: {
    control: false,
    description:
      "Callback function that is called when the columns selection state changes.",
    table: {
      type: {
        summary: "(columnSelection: string[]) => void",
      },
...
export const ColumnSizingArgTypes: ArgTypes = {
  columnSizing: {
    control: "object",
    description:
      "The column sizing state. An object with column ids as keys and sizes in pixels as values.",
    table: {
      type: {
  ...
  onColumnSizingChange: {
    control: false,
    description:
      "Callback function that is called when the column sizing state changes.",
    table: {
      type: {
