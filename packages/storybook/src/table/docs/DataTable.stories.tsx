...
import { type Entity, entityAllFields, makeEntity } from "./examples/entity";
import { type Person, makePerson, personColDef } from "./examples/person";
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div
            className={classNames("flex", "flex-row", "justify-end", "mb-m")}
          >
            <Button
              variant="primary"
              label="Add Row"
              onClick={() => {
                const newRow: Person = {
                  ...
                  age: 30,
                  jobArea:
                    JOB_AREAS[Math.floor(Math.random() * JOB_AREAS.length)],
                  jobDescriptor: "Chief",
  ...
  render: (props: TableProps<Person>) => {
    ...
    return (
      <customContext.Provider value={{ onRowChange }}>
        ...
        >
          <form
            className={classNames("w-full", "border-box")}
            style={{ blockSize: 400 }}
          >
        ...
        renderCell: (props) => {
          return (
            <InlineEditString variant="Select" {...props}>
              ...
              <Select.Option value="complicated">
                It s complicated
              </Select.Option>
              <Select.Option value="relationship">
                In a relationship
              </Select.Option>
            </InlineEditString>
          );
...
export const FlexColumns: StoryObj<TableProps<Person>> = {
  ...
  render: (props: TableProps<Person>) => {
    return (
      <div className={classNames("flex", "grow-1", "border-box")}>
        <Table {...props} />
      </div>
    );
  },
...
export const loading: StoryObj<TableProps<Entity>> = {
  ...
  render: (props: TableProps<Entity>) => {
    return (
      <div
        className={classNames("flex", "grow-1", "border-box")}
        style={{ blockSize: 300 }}
      >
        <Table {...props} />
      </div>
