...
import {
  ...
  entityRenderCell,
  makeEntity,
} from "./examples/entity";
import {
  type Product,
  productColDef,
  productsQlikCloud,
} from "./examples/product";
...
export const RenderCell: StoryObj<TableProps<Entity>> = {
  ...
  render: (props: TableProps<Entity>) => {
    return (
      <div className={classNames("w-l", "p-xl", "border-box", "h-screen")}>
        <Table {...props} />
      </div>
    );
  },
  ...
  render: ({ rows, ...props }: TableProps<Entity>) => {
    ...
    return (
      <div className={classNames("flex", "flex-col")}>
        ...
        <div
          className={classNames("flex", "flex-col", "p-0", "m-0")}
          style={{ minBlockSize: 200, maxBlockSize: 300 }}
        >
          <Table rows={data} {...props} />
        </div>
      </div>
...
export const DefaultColumnVisibility: StoryObj<TableProps<Entity>> = {
  ...
  render: () => {
    return (
      <div
        className={classNames("w-s", "p-xl", "border-box")}
        style={{ blockSize: 400 }}
      >
        <Table
          rowHeight={48}
