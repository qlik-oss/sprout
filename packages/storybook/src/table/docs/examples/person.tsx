import type { ColumnDef } from "@qlik/sprout-react-table";
    ...
    >
      ...
      >
        <rect
          ...
          height="4"
          rx="1"
          fill="var(--sprout-danger-color-default)"
        />
        <rect
          x={error}
          y="2"
          ...
          height="4"
          rx="1"
          fill="var(--sprout-info-color-default)"
        />
        <rect
          x={info}
          y="2"
          ...
          height="4"
          rx="1"
          fill="var(--sprout-success-color-default)"
        />
      </svg>
    </div>
  );
...
export const personColDef: Array<ColumnDef<Person>> = [
  {
    ...
    headerPlaceholder: () => (
      <QualityIndicator error={0} info={30} success={70} />
    ),
  },
  {
    field: "lastName",
    ...
    headerPlaceholder: () => (
      <QualityIndicator error={10} info={10} success={80} />
    ),
  },
  {
    field: "age",
    ...
    headerPlaceholder: () => (
      <QualityIndicator error={20} info={0} success={80} />
    ),
  },
  {
    field: "visits",
    ...
    headerPlaceholder: () => (
      <QualityIndicator error={0} info={0} success={100} />
    ),
  },
  {
    headerName: "Status",
