...
One common request for a dev is to display actions on hover. The issue with this approach is that it will not be accessible for keyboard users as they won't be able to see the actions on hover.
