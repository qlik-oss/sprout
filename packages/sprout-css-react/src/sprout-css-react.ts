...
/**
 * @deprecated
 * import { useControl } from '@qlik/sprout-css-hooks'; instead
 */
export const useControl = useControlPrimitive;

/**
 * @deprecated
 * import { useId } from '@qlik/sprout-css-hooks'; instead.
 */
export const useId = useIdBase;

/**
 * @deprecated
 * import { useContainer } from '@qlik/sprout-css-hooks'; instead.
 */
