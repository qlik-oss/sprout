...
/**
 * The `Slider.Single` component renders a single-value range slider with Field layout integration.
 * @param value - The controlled value.
 * @param defaultValue - The default value.
 * @param name - The name attribute for the hidden input.
 * @param onChange - Callback when the slider value changes during interaction.
