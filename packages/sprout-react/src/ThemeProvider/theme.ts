...
export function getTheme(
  ...
  if (element) {
    parent = {
      ...
      appearance: getParentDataAttribute<ThemeInternalAPI["appearance"]>(
        element,
        "appearance",
      ),
      density: getParentDataAttribute<ThemeInternalAPI["density"]>(
        element,
        "density",
      ),
      roundness: getParentDataAttribute<ThemeInternalAPI["roundness"]>(
        element,
        "roundness",
      ),
      sizing: getParentDataAttribute<ThemeInternalAPI["sizing"]>(
        element,
        "sizing",
      ),
      typography: getParentDataAttribute<ThemeInternalAPI["typography"]>(
        element,
        "typography",
      ),
    };
