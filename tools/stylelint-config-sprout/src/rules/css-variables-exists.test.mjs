  ...
  reject: [
    {
      ...
      message:
        'Unexpected token is undefined in "var(--sprout-whatever)" (sprout/css-variables-exists)',
    },
    {
      ...
      message:
        'Unexpected token is undefined in "var(--sprout-common-spacin-s)" (sprout/css-variables-exists)',
    },
  ],
});
