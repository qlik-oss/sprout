import"./react-sE-G6KV_.js";import"./sprout-DH_pwd-g.js";import{n as e}from"./lib-Btq7eDYl.js";import{t}from"./jsx-runtime-BtS28q-4.js";import"./react-dom-1IKd54jX.js";import{t as n}from"./Grid-DtoKnbl6.js";import{hn as r}from"./iframe-BRSAI4nO.js";var i=t(),a={title:`Components/Grid`},o={parameters:{chromatic:{modes:{breakpoint_s:{viewport:`s`},breakpoint_m:{viewport:`m`},breakpoint_l:{viewport:`l`}}}},render:()=>{let t=e();return(0,i.jsx)(n.Container,{className:t.classNames({s:[`p_l`],m:[`p_xl`]}),children:Array.from([,,,,,,]).map((e,a)=>(0,i.jsx)(n.Column,{s:`col_span_6`,m:`col_span_4`,className:t.classNames({s:[`border_dashed`,`p_m`],m:[`border_default`,`p_l`]},r(`items-center`,`flex`,`border-box`)),children:(0,i.jsx)(`span`,{children:a+1})},a))})}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  parameters: {
    chromatic: {
      modes: {
        breakpoint_s: {
