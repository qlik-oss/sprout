import{j as e,M as r}from"./iframe-BQJExRCF.js";import{useMDXComponents as t}from"./index-BiT2RrsF.js";import"./sprout-css-modules.stories-De69sx_s.js";import"./preload-helper-PPVm8Dsz.js";import"./sprout-DxA14K3u.js";function o(n){const s={a:"a",code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",...t(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"CSS/sprout-css-modules"}),`
...
`,e.jsxs(s.p,{children:["The second usage is when you already rely on ",e.jsx(s.code,{children:"@qlik/sprout-css-react"})," you don't need to add both package as this one re-export ",e.jsx(s.code,{children:"className"})," function for you."]}),`
`,e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-tsx",children:`import { classNames } from "@qlik/sprout-css-react";
