import{a as e,n as t,r as n}from"./chunk-BneVvdWh.js";import{Dt as r,E as i,In as a,Ln as o,Mn as s,Wt as c,Yt as l,_n as u,bn as d,ir as f,jn as p,jt as m,v as h,wt as g,xn as _}from"./iframe-B0xl5hqz.js";import{n as v,r as y,t as b}from"./Icons-Bt98yIEE.js";var x,S,C=t((()=>{y(),x={defaultActiveKey:{control:{type:`text`},description:`The default active tab key. Only for uncontrolled usage.`,table:{type:{summary:`string`}}},activeKey:{control:{type:`select`},options:[void 0,`assets-panel`,`settings-panel`,`users-panel`],description:"The active tab key. Use with `onSelect` for controlled usage.",table:{type:{summary:`string`}}},onSelect:{control:!1,description:"Callback fired when a tab is selected. Use with `activeKey` for controlled usage.",table:{type:{summary:`(event: any, key: string) => void`}}},size:{control:{type:`select`},options:[`s`,`m`],description:"The size of the tabs. Can be `s` or `m`. Default is `m`.",table:{type:{summary:`'s' | 'm'`},defaultValue:{summary:`m`}}},height:{control:{type:`select`},options:[`100%`,void 0],description:`Set the height of the tabs container to 100%.`,table:{type:{summary:`'100%' | undefined`}}},tabs:{control:!1,description:"Array of tab items. Each item should have `title`, `panel`, `aria-controls` and optionally `icon`, `badge`, and `disabled`. See `Tabs.Tab`.",table:{type:{summary:`TabItemPropTypes[]`}}},showTrack:{control:{type:`boolean`},description:`Whether to show the track under the selected tab.`,table:{type:{summary:`boolean`},defaultValue:{summary:`false`}}}},S={children:{control:!1,description:"**Tabs.Container**: should contain `Tabs.List` and `Tabs.Panel` components. <br/><br/> **Tabs.List**: should contain `Tabs.Tab` components. <br/><br/> **Tabs.Panel**: should contain the content for each tab.",table:{type:{summary:`ReactNode`}}},defaultActiveKey:{control:{type:`select`},options:[void 0,`Assets`,`Settings`,`Focusable`,`Users`],description:`The default active tab key. Only for uncontrolled usage.`,table:{type:{summary:`string`},subcategory:`Tabs.Container`}},activeKey:{control:{type:`select`},options:[void 0,`Assets`,`Settings`,`Focusable`,`Users`],description:"The active tab key. Use with `onSelect` for controlled usage.",table:{type:{summary:`string`},subcategory:`Tabs.Container`}},onSelect:{control:!1,description:"Callback fired when a tab is selected. Use with `activeKey` for controlled usage.",table:{type:{summary:`(event: any, key: string) => void`},subcategory:`Tabs.Container`}},size:{control:{type:`select`},options:[`s`,`m`],description:"The size of the tabs. Can be `s` or `m`. Default is `m`.",table:{type:{summary:`'s' | 'm'`},defaultValue:{summary:`m`},subcategory:`Tabs.Container`}},height:{control:{type:`select`},options:[`100%`,void 0],description:`Set the height of the tabs container to 100%.`,table:{type:{summary:`'100%' | undefined`},subcategory:`Tabs.Container`}},showTrack:{control:{type:`boolean`},description:`Whether to show the track under the selected tab.`,table:{type:{summary:`boolean`},defaultValue:{summary:`false`},subcategory:`Tabs.List`}},"aria-controls":{control:{type:`text`},description:"The id of the associated `Tab.Panel`. Used for accessibility.",table:{type:{summary:`string`},subcategory:`Tabs.Tab`}},title:{control:{type:`text`},description:`The title of the tab.`,table:{type:{summary:`string`},subcategory:`Tabs.Tab`}},badge:{control:!1,description:`Optional badge to display next to the title. See [Badge](./?path=/docs/components-badge--docs) for details.`,table:{type:{summary:`ReactNode`},subcategory:`Tabs.Tab`}},disabled:{control:{type:`boolean`},description:`Whether the tab is disabled.`,table:{type:{summary:`boolean`},subcategory:`Tabs.Tab`}},icon:{control:`select`,options:v,mapping:b,description:`Optional icon to display next to the title.`,table:{type:{summary:`ReactNode`},subcategory:`Tabs.Tab`}},useIconButton:{control:{type:`boolean`},description:`If true, Tab will only show the icon with no label.`,table:{type:{summary:`boolean`},defaultValue:{summary:`false`},subcategory:`Tabs.Tab`}},id:{control:{type:`text`},description:"The id of the tab panel. Should match the `aria-controls` of the associated `Tab`.",table:{type:{summary:`string`},subcategory:`Tabs.Panel`}},renderIf:{control:{type:`boolean`},description:`Whether the panel should unmount when hidden. If false, the panel remains in the DOM but hidden.`,table:{type:{summary:`boolean`},defaultValue:{summary:`false`},subcategory:`Tabs.Panel`}}}})),w=n({ControlledWithTabsProp:()=>I,Height:()=>N,TabsWithoutPanel:()=>M,Uncontrolled:()=>j,UncontrolledWithTabsProp:()=>F,VisualTests:()=>L,__namedExportsOrder:()=>R,default:()=>k});function T({children:e}){return(0,D.jsx)(`p`,{className:a(`font-body-s`,`text-default`),children:e})}var E,D,O,k,A,j,M,N,P,F,I,L,R,z=t((()=>{E=e(f()),h(),m(),C(),D=o(),{fn:O}=__STORYBOOK_MODULE_TEST__,k={title:`Components/Tabs`,component:i},A={chromatic:{disableSnapshot:!0}},j={render:e=>{let{defaultActiveKey:t,activeKey:n,size:r,height:o,onSelect:l,showTrack:u,title:f,icon:p,useIconButton:m}=e;return(0,D.jsx)(`div`,{className:a(`flex`,`flex-col`,`p-s`,`gap-s`,`w-fit`),"data-testid":`wrapper`,children:(0,D.jsxs)(i.Container,{defaultActiveKey:t,activeKey:n,size:r,height:o,onSelect:l,children:[(0,D.jsxs)(i.List,{showTrack:u,children:[(0,D.jsx)(i.Tab,{"aria-controls":`Assets`,title:f||`Assets`,icon:p||(0,D.jsx)(d,{}),useIconButton:m}),(0,D.jsx)(i.Tab,{"aria-controls":`Settings`,title:`Settings`,icon:(0,D.jsx)(c,{}),useIconButton:m}),(0,D.jsx)(i.Tab,{"aria-controls":`Focusable`,title:`Focusable`,useIconButton:m}),(0,D.jsx)(i.Tab,{"aria-controls":`Users`,title:`Users`,icon:(0,D.jsx)(s,{}),disabled:!0,useIconButton:m})]}),(0,D.jsx)(i.Panel,{id:`Assets`,children:(0,D.jsx)(T,{children:`Tab content for Assets`})}),(0,D.jsx)(i.Panel,{id:`Settings`,children:(0,D.jsx)(T,{children:`Tab content for Settings`})}),(0,D.jsxs)(i.Panel,{id:`Focusable`,children:[(0,D.jsx)(T,{children:`This panel content has some focusable elements so the focus should move directly to it if you use keyboard navigation.`}),(0,D.jsx)(g,{label:`Focusable button`})]}),(0,D.jsx)(i.Panel,{id:`Users`,children:`Tab content for Users`})]})})},args:{defaultActiveKey:`Assets`,onSelect:O(),showTrack:!0,title:`Assets`},argTypes:S,parameters:A},M={render:function(){let[e,t]=(0,E.useState)(`Assets`);return(0,D.jsxs)(`div`,{className:a(`flex`,`flex-col`,`p-s`,`gap-s`),"data-testid":`wrapper`,children:[(0,D.jsx)(i.Container,{activeKey:e,onSelect:(e,n)=>{t(n)},children:(0,D.jsxs)(i.List,{showTrack:!0,children:[(0,D.jsx)(i.Tab,{"aria-controls":`Assets`,title:`Assets`,icon:(0,D.jsx)(s,{})}),(0,D.jsx)(i.Tab,{"aria-controls":`Settings`,title:`Settings`,icon:(0,D.jsx)(p,{})}),(0,D.jsx)(i.Tab,{"aria-controls":`Users`,title:`Users`,icon:(0,D.jsx)(l,{})})]})}),(0,D.jsxs)(`div`,{className:a(`p-m`),id:e,role:`tabpanel`,children:[(0,D.jsxs)(T,{children:[`Current active tab: `,(0,D.jsx)(`strong`,{children:e})]}),(0,D.jsx)(T,{children:`This demonstrates a controlled Tabs component without Panels - the tab state is managed externally and can be used to control other parts of your UI.`})]})]})},parameters:{...A}},N={render:e=>{let{defaultActiveKey:t,activeKey:n,size:r,height:o,onSelect:s,showTrack:u,title:f,icon:p,useIconButton:m}=e;return(0,D.jsx)(`div`,{className:a(`flex`,`flex-col`,`p-s`,`gap-s`,`w-fit`),style:{blockSize:`500px`},"data-testid":`wrapper`,children:(0,D.jsxs)(i.Container,{defaultActiveKey:t,activeKey:n,size:r,height:o,onSelect:s,children:[(0,D.jsxs)(i.List,{showTrack:u,children:[(0,D.jsx)(i.Tab,{"aria-controls":`Assets`,title:f||`Assets`,icon:p||(0,D.jsx)(d,{}),useIconButton:m}),(0,D.jsx)(i.Tab,{"aria-controls":`Settings`,title:`Settings`,icon:(0,D.jsx)(c,{}),useIconButton:m}),(0,D.jsx)(i.Tab,{"aria-controls":`Focusable`,title:`Focusable`,useIconButton:m}),(0,D.jsx)(i.Tab,{"aria-controls":`Users`,title:`Users`,icon:(0,D.jsx)(l,{}),disabled:!0,useIconButton:m})]}),(0,D.jsx)(i.Panel,{id:`Assets`,children:Array.from({length:50},(e,t)=>(0,D.jsxs)(T,{children:[`Assets - Item `,t+1]},t))}),(0,D.jsx)(i.Panel,{id:`Settings`,children:Array.from({length:50},(e,t)=>(0,D.jsxs)(T,{children:[`Settings- Item `,t+1]},t))}),(0,D.jsxs)(i.Panel,{id:`Focusable`,children:[Array.from({length:50},(e,t)=>(0,D.jsxs)(T,{children:[`Focusable - Item `,t+1]},t)),(0,D.jsx)(g,{label:`Focusable button`})]}),(0,D.jsx)(i.Panel,{id:`Users`,children:Array.from({length:50},(e,t)=>(0,D.jsxs)(T,{children:[`Focusable - Item `,t+1]},t))})]})})},args:{defaultActiveKey:`Assets`,onSelect:O(),showTrack:!0,title:`Assets`,height:`100%`},argTypes:S},P=[{title:`Assets`,"aria-controls":`assets-panel`,icon:(0,D.jsx)(d,{}),badge:(0,D.jsx)(r,{text:`3`,color:`warning`,variant:`alphanumeric`}),panel:(0,D.jsx)(`div`,{className:a(`font-body-s`,`text-default`),children:`Tab 1 content`})},{title:`Settings`,"aria-controls":`settings-panel`,icon:(0,D.jsx)(c,{}),panel:(0,D.jsx)(`div`,{className:a(`font-body-s`,`text-default`),children:`Tab 2 content`})},{title:`Users`,"aria-controls":`users-panel`,icon:(0,D.jsx)(l,{}),panel:(0,D.jsx)(`div`,{className:a(`font-body-s`,`text-default`),children:`Tab 3 content`})}],F={render:({showTrack:e})=>(0,D.jsx)(`div`,{className:a(`flex`,`flex-col`,`p-s`,`gap-s`,`w-fit`),"data-testid":`wrapper`,children:(0,D.jsx)(i,{showTrack:e,tabs:P})}),args:{showTrack:!1},argTypes:x,parameters:A},I={render:e=>(0,D.jsx)(`div`,{className:a(`flex`,`flex-col`,`p-s`,`gap-s`,`w-fit`),"data-testid":`wrapper`,children:(0,D.jsx)(i,{...e,tabs:P})}),args:{showTrack:!1,activeKey:`assets-panel`,onSelect:O()},argTypes:x,parameters:A},L={render:()=>(0,D.jsxs)(`div`,{className:a(`flex`,`flex-col`,`p-s`,`gap-s`,`w-fit`),"data-testid":`wrapper`,children:[(0,D.jsxs)(i.Container,{defaultActiveKey:`Active`,children:[(0,D.jsxs)(i.List,{showTrack:!0,children:[(0,D.jsx)(i.Tab,{"aria-controls":`Active`,title:`ActiveTab`,icon:(0,D.jsx)(_,{}),badge:(0,D.jsx)(r,{variant:`alphanumeric`,color:`warning`,text:`3`})}),(0,D.jsx)(i.Tab,{"aria-controls":`Enabled`,title:`EnabledTab`,icon:(0,D.jsx)(d,{})}),(0,D.jsx)(i.Tab,{"aria-controls":`Hovered`,title:`HoveredTab`,"data-testid":`hover`}),(0,D.jsx)(i.Tab,{"aria-controls":`Focused`,title:`FocusedTab`,"data-testid":`focus`}),(0,D.jsx)(i.Tab,{"aria-controls":`DisabledTab`,title:`DisabledTab`,icon:(0,D.jsx)(u,{}),disabled:!0})]}),(0,D.jsx)(i.Panel,{id:`Active`,children:(0,D.jsx)(T,{children:`content`})}),(0,D.jsx)(i.Panel,{id:`Enabled`,children:(0,D.jsx)(T,{children:`content`})}),(0,D.jsx)(i.Panel,{id:`Hovered`,children:(0,D.jsx)(T,{children:`content`})}),(0,D.jsx)(i.Panel,{id:`Focused`,children:(0,D.jsx)(T,{children:`content`})}),(0,D.jsx)(i.Panel,{id:`Users`,children:(0,D.jsx)(T,{children:`content`})})]}),(0,D.jsxs)(i.Container,{defaultActiveKey:`Small Active`,size:`s`,children:[(0,D.jsxs)(i.List,{showTrack:!0,children:[(0,D.jsx)(i.Tab,{"aria-controls":`Small Active`,title:`Small ActiveTab`,icon:(0,D.jsx)(_,{}),badge:(0,D.jsx)(r,{variant:`alphanumeric`,color:`warning`,text:`3`})}),(0,D.jsx)(i.Tab,{"aria-controls":`Small Enabled`,title:`Small EnabledTab`,icon:(0,D.jsx)(d,{})}),(0,D.jsx)(i.Tab,{"aria-controls":`Small Hovered`,title:`Small HoveredTab`,"data-testid":`hover`}),(0,D.jsx)(i.Tab,{"aria-controls":`Small Focused`,title:`Small FocusedTab`,"data-testid":`focus`}),(0,D.jsx)(i.Tab,{"aria-controls":`Small DisabledTab`,title:`Small DisabledTab`,icon:(0,D.jsx)(u,{}),disabled:!0})]}),(0,D.jsx)(i.Panel,{id:`Small Active`,children:(0,D.jsx)(T,{children:`content`})}),(0,D.jsx)(i.Panel,{id:`Small Enabled`,children:(0,D.jsx)(T,{children:`content`})}),(0,D.jsx)(i.Panel,{id:`Small Hovered`,children:(0,D.jsx)(T,{children:`content`})}),(0,D.jsx)(i.Panel,{id:`Small Focused`,children:(0,D.jsx)(T,{children:`content`})}),(0,D.jsx)(i.Panel,{id:`Small DisabledTab`,children:(0,D.jsx)(T,{children:`content`})})]}),(0,D.jsx)(i,{showTrack:!0,tabs:P})]}),parameters:{controls:{disable:!0},pseudo:{hover:`[data-testid="hover"]`,focusVisible:`[data-testid="focus"]`}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  render: props => {
    const {
      defaultActiveKey,
      activeKey,
