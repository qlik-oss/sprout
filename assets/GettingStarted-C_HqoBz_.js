...
function App() {
  ...
  return (
    <ThemeProvider asDiv>
      <h1 className={classNames("m-0", "p-0", "text-default", "font-heading-m")}>Vite + React</h1>
      <div className={className("flex", "flex-col", "gap-xs")}>
        <Button variant="primary" onClick={() => setCount((count) => count + 1)} label={\`Count is \${count}\`} />
        <p className={className("text-default", "font-body-m")}>
...
`,e.jsxs(t.li,{children:["When setting up a Storybook instance (though we recommend using ",e.jsx(t.code,{children:"@qlik/sprout-storybook"})," for this purpose)."]}),`
`]}),`
...
`,e.jsxs(t.p,{children:["Setting up Sprout CSS in Storybook is straightforward. You can use the ",e.jsx(t.code,{children:"@qlik/sprout-storybook"})," package to simplify the process."]}),`
`,e.jsx(t.pre,{children:e.jsx(t.code,{className:"language-jsx",children:`import { getSproutGlobalTypes, sproutCSSDecorator } from "@qlik/sprout-storybook";
...
`,e.jsx(t.p,{children:"Sprout CSS is designed to make your development experience smoother while ensuring a consistent and polished design system. If you encounter any issues or have suggestions, feel free to reach out or contribute to the project. Happy coding!"})]})}function c(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(o,{...n})}):o(n)}export{c as default};
