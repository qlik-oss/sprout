import{j as r}from"./iframe-BThSoDrn.js";import{u as o,G as a}from"./Grid-2EGydKLe.js";import{c as m}from"./classNames-dIthk07I.js";import"./preload-helper-PPVm8Dsz.js";import"./sprout-C7A3N88C.js";const _={title:"Components/Grid"},e={parameters:{chromatic:{modes:{breakpoint_s:{viewport:"s"},breakpoint_m:{viewport:"m"},breakpoint_l:{viewport:"l"}}}},render:()=>{const s=o();return r.jsx(a.Container,{className:s.classNames({s:["p_l"],m:["p_xl"]}),children:Array.from(Array(6)).map((t,n)=>r.jsx(a.Column,{s:"col_span_6",m:"col_span_4",className:s.classNames({s:["border_dashed","p_m"],m:["border_default","p_l"]},m("items-center","flex","border-box")),children:r.jsx("span",{children:n+1})},n))})}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  parameters: {
    chromatic: {
      modes: {
        breakpoint_s: {
