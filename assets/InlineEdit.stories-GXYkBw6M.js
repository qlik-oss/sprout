import{a as e,n as t,r as n}from"./chunk-BneVvdWh.js";import{Fn as r,G as i,M as a,Pn as o,W as s,fn as c,jt as l,nr as u,v as d}from"./iframe-RiXBydPV.js";import{n as f,t as p}from"./SelectTest-DrCQF0Gj.js";import{n as m,t as h}from"./lib-Mf9b06gq.js";var g,_,v,y,b,x=t((()=>{g={showEditIcon:{control:{type:`boolean`},description:`Displays an edit icon next to the value.`,table:{type:{summary:`boolean`}}},showFormButtons:{control:{type:`boolean`},description:`Displays form buttons (save/cancel) when editing as an overlay to the edit view.`,table:{type:{summary:`boolean`}}},onSave:{control:!1,description:`function called when the user validate the action`,table:{type:{summary:`() => void`}}},onCancel:{control:!1,description:`function called when the user cancel the action`,table:{type:{summary:`() => void`}}},showEditButton:{table:{disable:!0}},blurAction:{control:{type:`select`},options:[`cancel`,`save`],description:`Action to perform when the input loses focus.`,table:{type:{summary:`"cancel" | "save"`}}},isEditing:{control:{type:`select`},options:[void 0,!0,!1],description:`Controls whether the component is in editing mode.`,table:{type:{summary:`boolean`}}},isEditingDefault:{control:{type:`select`},options:[void 0,!0,!1],description:`Initial state of the component when it is first rendered.`,table:{type:{summary:`boolean`}}},onEdit:{control:!1,description:`Function called when the user clicks on the edit icon.`,table:{type:{summary:`(isEditing: boolean) => void`}}},errorMessages:{control:{type:`object`},description:`Array of error messages to display when the input has errors.`,table:{type:{summary:`string[]`}}},placeholder:{control:{type:`text`},description:`Placeholder text for the multi-select input.`,table:{type:{summary:`string`}}},hasError:{control:{type:`boolean`},description:`Indicates whether the multi-select has an error state.`,table:{type:{summary:`boolean`}}}},_={view:{control:!1,description:`Custom view component to render the value in view mode.`,table:{type:{summary:`JSX.Element | (() => JSX.Element)`}}},edit:{control:!1,description:`Custom edit component to render the value in edit mode.`,table:{type:{summary:`JSX.Element | (() => JSX.Element)`}}},editFocusSelector:{control:{type:`text`},description:`CSS selector to focus the edit component when it is opened.`,table:{type:{summary:`string`},defaultValue:{summary:`a[href], button:not(:disabled), input:not(:disabled), textarea:not(:disabled), select:not(:disabled), [tabindex]:not([tabindex="-1"])`}}},editOffsetX:{control:{type:`number`},description:`Horizontal offset for the edit component.`,table:{type:{summary:`number`}}}},v={value:{control:{type:`text`},description:`Current value of the text field in Controlled mode.`,table:{type:{summary:`string`}}},defaultValue:{control:{type:`text`},description:`Initial value of the text field in Uncontrolled mode.`,table:{type:{summary:`string`}}},onChange:{control:!1,description:`Function called when the input value changes.`,table:{type:{summary:`(value: string) => void`}}},font:{control:{type:`select`},options:[`label_xl`,`label_l`,`label_m`,`label_s`,`label_xs`],description:`Sets the font style for the text field.`,table:{type:{summary:`"label_xl" | "label_l" | "label_m" | "label_s" | "label_xs"`},defaultValue:{summary:`label_s`}}}},y={children:{control:`object`,description:`Options to display in the select dropdown.`},defaultValue:{control:{type:`select`},options:[`red`,`blue`,`green`,`yellow`,`purple`,`orange`],description:`Initial value of the select in Uncontrolled mode.`,table:{type:{summary:`string`}}},value:{control:{type:`select`},options:[`red`,`blue`,`green`,`yellow`,`purple`,`orange`],description:`Current value of the select in Controlled mode.`,table:{type:{summary:`string`}}},onChange:{control:!1,description:`Function called when the selected option changes.`,table:{type:{summary:`(value: string, reason?: ChangeReasons | 'cancel') => void`}}}},b={children:{control:!1,description:`Options to display in the multi-select dropdown.`,table:{type:{summary:`ReactNode`}}},defaultValue:{control:{type:`multi-select`},options:[`red`,`blue`,`green`,`yellow`,`purple`,`orange`]},value:{control:{type:`multi-select`},options:[`red`,`blue`,`green`,`yellow`,`purple`,`orange`]},onChange:{control:!1,description:`Function called when the selected options change.`,table:{type:{summary:`(value: string[], reason?: ChangeReasons | 'cancel') => void`}}}}})),S=n({CustomInlineEdit:()=>L,InlineEditTable:()=>H,MultiSelect:()=>N,SelectDemo:()=>M,TextField:()=>k,VisualTestMultiSelect:()=>I,VisualTestSelect:()=>F,VisualTestTextField:()=>P,__namedExportsOrder:()=>U,default:()=>O});function C({row:e,attr:t,label:n}){let r=(0,T.useContext)(V),[i,a]=(0,T.useState)(e[t]);return(0,T.useEffect)(()=>{a(e[t])},[e[t]]),(0,E.jsx)(`div`,{className:o(`px-s`,`w-full`,`h-full`,`whitespace-nowrap`,`overflow-hidden`),children:(0,E.jsx)(s.Select,{value:i,onChange:(n,r)=>{if(r===`cancel`){a(e[t]);return}a(n.target.value)},onSave:()=>{r.onRowChange({...e,[t]:i})},"aria-label":n,onSubmit:()=>{console.log(`submit`,i),r.onRowChange({...e,[t]:i})},children:B})})}function w({row:e,attr:t,label:n}){let r=(0,T.useContext)(V),[i,a]=(0,T.useState)(e[t]);return(0,T.useEffect)(()=>{a(e[t])},[e[t]]),(0,E.jsx)(`div`,{className:o(`px-s`,`border-box`,`w-full`,`relative`),children:(0,E.jsx)(s.TextField,{value:i,onChange:(n,r)=>{if(r===`cancel`){a(e[t]);return}a(n.target.value)},onSave:()=>{r.onRowChange({...e,[t]:i})},"aria-label":n,onSubmit:()=>{console.log(`submit`,i),r.onRowChange({...e,[t]:i})}})})}var T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W=t((()=>{T=e(u()),d(),h(),l(),f(),x(),E=r(),{fn:D}=__STORYBOOK_MODULE_TEST__,O={title:`Components/InlineEdit`},k={name:`TextField`,parameters:{chromatic:{disableSnapshot:!0}},render:e=>(0,E.jsx)(`div`,{className:o(`flex`,`border-box`,`p-xl`,`w-xs`),children:(0,E.jsx)(s.TextField,{...e})}),args:{defaultValue:`Edit me`,"aria-label":`Edit color`,onSave:D(),onCancel:D(),onChange:D()},argTypes:{...g,...v}},A=[`This is an error message`],j=[(0,E.jsx)(i.Option,{value:``,children:(0,E.jsx)(`div`,{className:o(`text-weak`),children:`empty`})},`empty`),(0,E.jsx)(i.Option,{value:`red`,children:`Red`},`red`),(0,E.jsx)(i.Option,{value:`default`,children:`Default`},`default`),(0,E.jsx)(i.Option,{value:`hovered`,children:`Hovered`},`hovered`),(0,E.jsx)(i.Option,{value:`focused`,children:`Focused`},`focused`),(0,E.jsx)(i.Option,{value:`editing`,children:`Editing`},`editing`),(0,E.jsx)(i.Option,{value:`hasError`,children:`Has Error`},`hasError`)],M={name:`Select`,args:{defaultValue:`red`},argTypes:{...g,...y},parameters:{chromatic:{disableSnapshot:!0}},render:e=>(0,E.jsx)(`div`,{className:o(`flex`,`border-box`,`p-xl`,`w-xs`),children:(0,E.jsx)(s.Select,{"aria-label":`Edit color`,...e,children:p})})},N={parameters:{chromatic:{disableSnapshot:!0}},argTypes:{...g,...b},args:{defaultValue:[`blue`,`red`]},render:e=>(0,E.jsx)(`div`,{className:o(`flex`,`border-box`,`p-xl`,`w-xs`),children:(0,E.jsx)(s.MultiSelect,{"aria-label":`Edit colors`,...e,children:p})})},P={parameters:{pseudo:{hover:[`[data-testid="hovered.view"]`],active:`[data-testid="actived.view"]`,focusVisible:`[data-testid="focused"] > [role="button"]`}},render:()=>(0,E.jsxs)(`div`,{className:o(`flex`,`border-box`,`flex-col`,`gap-3xl`),children:[(0,E.jsx)(`h2`,{className:o(`flex`,`border-box`,`font-heading-m`,`text-default`),children:`InlineEdit.TextField`}),(0,E.jsxs)(`div`,{className:o(`flex`,`border-box`,`flex-row`,`gap-xl`,`p-m`,`items-center`,`justify-start`,`w-fit`),children:[(0,E.jsx)(`div`,{className:o(`flex`,`border-box`,`w-fit`,`p-m`),children:(0,E.jsx)(s.TextField,{"aria-label":`Edit color`,defaultValue:``,placeholder:`placeholder`})}),(0,E.jsx)(`div`,{className:o(`flex`,`border-box`,`w-fit`,`p-m`),children:(0,E.jsx)(s.TextField,{"aria-label":`Edit color`,defaultValue:`default value`,showEditIcon:!0})}),(0,E.jsx)(`div`,{className:o(`flex`,`border-box`,`w-fit`,`p-m`),children:(0,E.jsx)(s.TextField,{"aria-label":`Edit color`,defaultValue:`Hover + showEditIcon`,showEditIcon:!0,"data-testid":`hovered`})}),(0,E.jsx)(`div`,{className:o(`flex`,`border-box`,`w-fit`,`p-m`),children:(0,E.jsx)(s.TextField,{"aria-label":`Edit color`,defaultValue:`Hover`,"data-testid":`hovered`})}),(0,E.jsx)(`div`,{className:o(`flex`,`border-box`,`w-fit`,`p-m`),children:(0,E.jsx)(s.TextField,{"aria-label":`Edit color`,defaultValue:`Focus`,"data-testid":`focused`})}),(0,E.jsx)(`div`,{className:o(`flex`,`border-box`,`p-m`),style:{inlineSize:`100px`},children:(0,E.jsx)(s.TextField,{"aria-label":`Edit color`,defaultValue:`Default with overflow`})})]}),(0,E.jsx)(`h2`,{className:o(`flex`,`border-box`,`font-heading-m`,`text-default`),children:`InlineEdit.TextField editMode`}),(0,E.jsxs)(`div`,{className:o(`flex`,`border-box`,`flex-row`,`gap-xl`,`p-m`,`items-center`,`justify-start`),style:{inlineSize:`500px`},children:[(0,E.jsx)(s.TextField,{"aria-label":`Edit color`,defaultValue:`Edit`,showEditIcon:!0,isEditingDefault:!0}),(0,E.jsx)(s.TextField,{"aria-label":`Edit color`,defaultValue:`Edit + showFormButtons`,showFormButtons:!0,isEditingDefault:!0})]}),(0,E.jsx)(`h2`,{className:o(`flex`,`border-box`,`font-heading-m`,`text-default`),children:`InlineEdit.TextField editMode vs view mode`}),(0,E.jsxs)(`div`,{className:o(`flex`,`border-box`,`flex-row`,`gap-xl`,`p-m`,`items-center`,`justify-start`),style:{inlineSize:`500px`},children:[(0,E.jsx)(s.TextField,{"aria-label":`Edit color`,defaultValue:`Should not     trim   spaces.   WYSIWYG`,isEditing:!0}),(0,E.jsx)(s.TextField,{"aria-label":`Edit color`,defaultValue:`Should not     trim   spaces.   WYSIWYG`})]}),(0,E.jsx)(`h2`,{className:o(`flex`,`border-box`,`font-heading-m`,`text-default`),children:`InlineEdit.TextField editMode + error`}),(0,E.jsxs)(`div`,{className:o(`flex`,`border-box`,`flex-row`,`gap-xl`,`p-m`,`items-start`,`justify-start`),style:{inlineSize:`1000px`,blockSize:`150px`},children:[(0,E.jsx)(`div`,{className:o(`flex`,`border-box`,`grow`,`shrink-0`),style:{flexBasis:1},children:(0,E.jsx)(s.TextField,{"aria-label":`Edit color`,defaultValue:`Edit + Error`,hasError:!0,isEditingDefault:!0})}),(0,E.jsx)(`div`,{className:o(`flex`,`border-box`,`grow`,`shrink-0`),style:{flexBasis:1},children:(0,E.jsx)(s.TextField,{"aria-label":`Edit color`,defaultValue:`Error + showFormButtons`,hasError:!0,showFormButtons:!0,isEditingDefault:!0})}),(0,E.jsx)(`div`,{className:o(`flex`,`border-box`,`grow`,`shrink-0`),style:{flexBasis:1},children:(0,E.jsx)(s.TextField,{"aria-label":`Edit color`,defaultValue:`Error + errorMessages`,hasError:!0,isEditingDefault:!0,errorMessages:A})}),(0,E.jsx)(`div`,{className:o(`flex`,`border-box`,`grow`,`shrink-0`),style:{flexBasis:1},children:(0,E.jsx)(s.TextField,{"aria-label":`Edit color`,defaultValue:`Error + errorMessages + showFormButtons`,hasError:!0,showFormButtons:!0,isEditingDefault:!0,errorMessages:A})})]}),(0,E.jsx)(`h2`,{className:o(`flex`,`border-box`,`font-heading-m`,`text-default`),children:`InlineEdit.TextField font`}),(0,E.jsxs)(`div`,{className:o(`flex`,`border-box`,`flex-row`,`gap-xl`,`p-m`,`items-center`,`justify-start`),children:[(0,E.jsx)(`div`,{className:o(`flex`,`border-box`,`w-fit`,`p-m`),children:(0,E.jsx)(s.TextField,{"aria-label":`Edit color`,defaultValue:`custom font heading_xl`,font:`heading_xl`,showEditIcon:!0})}),(0,E.jsx)(`div`,{className:o(`flex`,`border-box`,`w-fit`,`p-m`),children:(0,E.jsx)(s.TextField,{"aria-label":`Edit color`,defaultValue:`custom font script_s`,font:`script_s`,view:({children:e})=>(0,E.jsx)(`span`,{className:o(`text-end`,`font-script-s`,`text-inverse`,`bg-inverse`),children:e}),showEditIcon:!0})})]})]})},F={parameters:{pseudo:{hover:[`[data-testid="hovered.view"][role="button"]`,`[data-testid="focused"] [role="button"]`],active:`[data-testid="actived"]`,focusVisible:[`[data-testid="focused"] > role="button"`,`[data-testid="focused.edit"] [role="combobox"]`]}},render:()=>(0,E.jsxs)(`div`,{className:o(`flex`,`border-box`,`flex-col`,`gap-3xl`),children:[(0,E.jsx)(`h2`,{className:o(`flex`,`border-box`,`font-heading-m`,`text-default`),children:`InlineEdit.Select`}),(0,E.jsxs)(`div`,{className:o(`flex`,`border-box`,`flex-col`,`gap-xxl`),children:[(0,E.jsxs)(`div`,{className:o(`w-xxs`,`flex`,`flex-col`,`gap-xl`),children:[(0,E.jsx)(s.Select,{"aria-label":`Edit color`,defaultValue:`default`,showEditIcon:!0,children:j}),(0,E.jsx)(s.Select,{"aria-label":`Edit color`,defaultValue:`hovered`,showEditIcon:!0,"data-testid":`hovered`,children:j}),(0,E.jsx)(s.Select,{"aria-label":`Edit color`,defaultValue:`focused`,showEditIcon:!0,"data-testid":`focused`,children:j})]}),(0,E.jsxs)(`div`,{className:o(`w-l`,`flex`,`flex-row`,`gap-xxl`,`items-start`),style:{blockSize:`250px`},children:[(0,E.jsx)(s.Select,{"aria-label":`Edit color`,defaultValue:`editing`,showEditIcon:!0,isEditingDefault:!0,children:j}),(0,E.jsx)(s.Select,{"aria-label":`Edit color`,defaultValue:`hasError`,hasError:!0,isEditingDefault:!0,children:j}),(0,E.jsx)(s.Select,{"aria-label":`Edit color`,defaultValue:`focused`,showEditIcon:!0,"data-testid":`focused`,showFormButtons:!0,isEditingDefault:!0,children:j})]})]})]})},I={parameters:{pseudo:{hover:[`[data-testid="hovered"]`,`[data-testid="focused"] > button`],active:`[data-testid="actived"]`,focusVisible:`[data-testid="focused"] > button`}},render:()=>(0,E.jsxs)(`div`,{className:o(`flex`,`border-box`,`flex-col`,`gap-3xl`),children:[(0,E.jsx)(`h2`,{className:o(`flex`,`border-box`,`font-heading-m`,`text-default`),children:`InlineEdit.MultiSelect`}),(0,E.jsxs)(`div`,{className:o(`flex`,`border-box`,`flex-col`,`gap-xxl`,`items-start`),children:[(0,E.jsxs)(`div`,{className:o(`w-xxs`,`flex`,`gap-xl`),children:[(0,E.jsx)(s.MultiSelect,{"aria-label":`Edit colors`,defaultValue:[`default`],showEditIcon:!0,children:j}),(0,E.jsx)(s.MultiSelect,{"aria-label":`Edit colors`,defaultValue:[`hovered`],showEditIcon:!0,"data-testid":`hovered`,children:j}),(0,E.jsx)(s.MultiSelect,{"aria-label":`Edit colors`,defaultValue:[`focused`],showEditIcon:!0,"data-testid":`focused`,children:j})]}),(0,E.jsxs)(`div`,{className:o(`w-xl`,`flex`,`flex-row`,`gap-xxl`,`items-start`),style:{blockSize:`250px`},children:[(0,E.jsx)(s.MultiSelect,{"aria-label":`Edit colors`,defaultValue:[`editing`],showEditIcon:!0,isEditingDefault:!0,children:j}),(0,E.jsx)(s.MultiSelect,{"aria-label":`Edit colors`,defaultValue:[`hasError`],hasError:!0,isEditingDefault:!0,children:j}),(0,E.jsx)(s.MultiSelect,{"aria-label":`Edit colors`,defaultValue:[`editing`],showEditIcon:!0,showFormButtons:!0,isEditingDefault:!0,children:j})]})]})]})},L={render:e=>{let[t,n]=(0,T.useState)(!0),[r,i]=(0,T.useState)(!0);return(0,E.jsx)(`div`,{className:o(`flex`,`border-box`,`p-xl`,`w-xs`,`bg-weak`),children:(0,E.jsx)(s.Primitive,{onCancel:()=>{n(r)},onSave:()=>{i(t)},view:(0,E.jsxs)(`div`,{className:o(`flex`,`flex-row`,`gap-m`,`items-center`,`w-full`,`text-default`,`bg-default`),children:[(0,E.jsx)(c,{className:o(`fill-current`)}),(0,E.jsxs)(`div`,{className:o(`flex`,`flex-col`,`gap-m`),children:[(0,E.jsx)(`span`,{className:o(`font-label-m-emphasized`,`text-default`),children:t?`On`:`Off`}),(0,E.jsx)(`span`,{className:o(`font-label-s`,`text-weak`),children:`AI Features`})]})]}),edit:(0,E.jsx)(`div`,{className:o(`flex`,`flex-row`,`bg-default`,`gap-m`,`px-m`,`py-xl`,`items-center`),children:(0,E.jsx)(a,{checked:t,onChange:()=>{n(e=>!e)},label:`AI Features`})}),...e})})},args:{showFormButtons:!0,onSave:D()},argTypes:_},R={ADMIN:`Administrator with extended system permissions that allows managing users, settings, and content across the platform.`,EDITOR:`Editor`,USER:`User`,VIEWER:`Viewer`},z=[{uuid:`1`,firstName:`John`,lastName:`Doe`,bio:`Lorem ipsum dolor sit amet.`,role:R.ADMIN},{uuid:`2`,firstName:`Jane`,lastName:`Smith`,bio:`Consectetur adipiscing elit.`,role:R.EDITOR},{uuid:`3`,firstName:`Alice`,lastName:`Johnson`,bio:`Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`,role:R.USER},{uuid:`4`,firstName:`Bob`,lastName:`Brown`,bio:`Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.`,role:R.VIEWER},{uuid:`5`,firstName:`Charlie`,lastName:`Davis`,bio:`Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore fugiat nulla pariatur.`,role:R.USER},{uuid:`6`,firstName:`Eve`,lastName:`Wilson`,bio:`Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.`,role:R.ADMIN},{uuid:`7`,firstName:`Frank`,lastName:`Garcia`,bio:`Curabitur pretium tincidunt lacus. Nulla gravida orci a odio. Nullam varius, turpis et commodo pharetra, est eros bibendum elit, nec luctus magna felis sollicitudin.`,role:R.USER},{uuid:`8`,firstName:`Grace`,lastName:`Martinez`,bio:`Integer in mauris eu nibh. Nullam mollis. Etiam vel erat sed augue blandit sodales. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Morbi lacinia molestie dui.`,role:R.EDITOR},{uuid:`9`,firstName:`Hank`,lastName:`Lopez`,bio:`Praesent id justo in neque elementum ultrices. Fusce fermentum. Donec ut mauris eget massa tempor convallis. Nulla facilisi.`,role:R.VIEWER},{uuid:`10`,firstName:`Ivy`,lastName:`Hernandez`,bio:`Sed lectus. Integer euismod lacus luctus magna, non interdum quam sodales ut. Sed lectus. Integer euismod lacus luctus magna, non interdum quam sodales ut.`,role:R.USER}],B=[(0,E.jsx)(i.Option,{value:R.ADMIN,children:R.ADMIN},`admin`),(0,E.jsx)(i.Option,{value:R.EDITOR,children:R.EDITOR},`editor`),(0,E.jsx)(i.Option,{value:R.USER,children:R.USER},`user`),(0,E.jsx)(i.Option,{value:R.VIEWER,children:R.VIEWER},`viewer`)],V=(0,T.createContext)({onRowChange:()=>{}}),H={name:`InlineEdit in Table`,parameters:{chromatic:{disableSnapshot:!0}},render:e=>{let[t,n]=(0,T.useState)(z),r=(0,T.useCallback)(()=>e=>{n(t=>t.map(t=>t.uuid===e.uuid?{...t,...e}:t))},[t]);return(0,E.jsx)(V.Provider,{value:{onRowChange:r},children:(0,E.jsx)(`div`,{className:o(`w-full`,`p-xl`,`border-box`),style:{blockSize:300},children:(0,E.jsx)(m,{...e,rows:t,getRowId:e=>e.uuid})})})},args:{variant:`data`,columns:[{field:`firstName`,headerName:`First Name`,renderCell:({row:e,colDef:t})=>(0,E.jsx)(w,{row:e,attr:`firstName`,label:t.headerName})},{field:`lastName`,headerName:`Last Name`,renderCell:({row:e,colDef:t})=>(0,E.jsx)(w,{row:e,attr:`lastName`,label:t.headerName})},{field:`role`,headerName:`Role`,renderCell:({row:e,colDef:t})=>(0,E.jsx)(C,{row:e,attr:`role`,label:t.headerName})},{field:`bio`,headerName:`Bio`,flex:1,renderCell:({row:e,colDef:t})=>(0,E.jsx)(w,{row:e,attr:`bio`,label:t.headerName})}]}},k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  name: "TextField",
  parameters: {
    chromatic: {
