import{a as e,i as t,s as n}from"./preload-helper-xPQekRTU.js";import{t as r}from"./react-a45N5K9M.js";import{t as i}from"./jsx-runtime-BqsN2jGA.js";import{Fn as a,O as o,Ot as s,St as c,Tn as l,an as u,bt as d,qn as f,rn as p,ta as m,ti as h,vt as g,yr as _}from"./iframe-UwarwtgL.js";function v(e,t){let n=(0,y.useRef)(null),r=(0,y.useRef)(document.activeElement),i=(0,y.useRef)(null);return(0,y.useEffect)(()=>{if(!t&&t!==void 0)return;let a=n.current,o=r.current;i.current=document.activeElement,i.current.blur();let s=a.querySelectorAll(b),c=s.length;if(c===0)throw Error(`At least one tabbable element needs to be present within your target. If you feel this is a mistake and there is a tabbable element on your target, try adding your tabbable element within the optional tabbableElems parameter.`);let l=s[0],u=s[c-1];if(e===`first`||e===void 0)l.focus();else if(e===`container`)a.focus();else throw Error(`initialFocus must be either the values 'first', 'container'. You specified initialFocus as ${typeof e}`);let d=e=>{if(e.key===`Tab`){let t=document.activeElement,n=t=>{t.focus(),e.preventDefault()};!e.shiftKey&&t===u&&n(l),e.shiftKey&&t===l&&n(u)}};return a.addEventListener(`keydown`,d),()=>{o?o.focus():i.current&&i.current.focus(),a.removeEventListener(`keydown`,d)}},[t]),n}var y,b,x=t((()=>{y=n(r()),b=`a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), area[href], form, audio[controls], video[controls], [tabindex="0"]`}));function S(e){return(0,C.jsx)(`div`,{ref:v(`container`,!0),...e})}var C,w=t((()=>{C=i(),x()})),T=t((()=>{w()})),E,D,O=t((()=>{E={demoContentWidth:{control:{type:`number`,min:0,step:50}},demoContentHeight:{control:{type:`number`,min:0,step:50}},demoContainerWidth:{control:{type:`number`,min:0,step:50}},demoContainerHeight:{control:{type:`number`,min:0,step:50}}},D={content:{control:!1,description:`The content of the popover.`,table:{type:{summary:`ReactNode`}}},children:{control:!1,description:`The anchor element that the popover is attached to. It's not required as you can use anchorPosition instead.`,table:{type:{summary:`ReactNode`}}},anchorEl:{control:!1,description:`The anchor element that the popover is attached to. It's not required as you can use anchorPosition instead.`,table:{type:{summary:`HTMLElement | null`}}},placement:{control:{type:`select`},options:[void 0,`bottom`,`bottom-start`,`bottom-end`,`left`,`left-start`,`left-end`,`right`,`right-start`,`right-end`,`top`,`top-start`,`top-end`],description:`The preferred placement of the popover relative to the anchor element.`,table:{defaultValue:{summary:`bottom-start`},type:{summary:`string`}}},placementUpdate:{control:{type:`select`},options:[void 0,!0,!1,`dropdown`],description:`If true, the popover will update its position when the anchor element changes position.`,table:{defaultValue:{summary:void 0},type:{summary:`boolean`}}},anchorPosition:{control:{type:`object`},description:`The position of the anchor element in the viewport. Used when there is no children prop.`,table:{type:{summary:`{ top: number; left: number }`}}},open:{control:{type:`select`},options:[void 0,!0,!1],description:`Controls the visibility of the popover. If undefined, the popover will manage its own state.`,table:{defaultValue:{summary:void 0},type:{summary:`boolean`}}},initialOpen:{control:{type:`select`},options:[void 0,!0,!1],description:`Controls the initial visibility of the popover.`,table:{defaultValue:{summary:void 0},type:{summary:`boolean`}}},onOpenChange:{control:!1,description:`Callback fired when the open state of the popover changes.`,table:{type:{summary:`(open: boolean) => void`}}},hideBackdrop:{control:{type:`boolean`},description:`If true, hides the backdrop overlay (no overlay is rendered behind the popover), allowing interaction with the background.`,table:{defaultValue:{summary:`true`},type:{summary:`boolean`}}},disableScrollLock:{control:{type:`boolean`},description:`If true, disables scroll locking when the backdrop/overlay is shown (i.e., when hideBackdrop is false), allowing the page to continue scrolling in the background.`,table:{defaultValue:{summary:`true`},type:{summary:`boolean`}}},width:{control:{type:`select`},options:[void 0,`reference`,`screen`,`xxs`,`xs`,`s`,`m`,`l`,`xl`,`100px`],description:`Sets the width of the popover. Can be a predefined size or a custom CSS value.`,table:{defaultValue:{summary:`fit-content`},type:{summary:` "reference" | "screen" | "xxs" | "xs" | "s" | "m" | "l" | "xl" | string`}}},minWidth:{control:{type:`select`},options:[void 0,`reference`,`screen`,`xxs`,`xs`,`s`,`m`,`l`,`xl`,`100px`],description:`Sets the minimum width of the popover. Can be a predefined size or a custom CSS value.`,table:{defaultValue:{summary:void 0},type:{summary:` "reference" | "screen" | "xxs" | "xs" | "s" | "m" | "l" | "xl" | string`}}},maxWidth:{control:{type:`select`},options:[void 0,`reference`,`screen`,`xxs`,`xs`,`s`,`m`,`l`,`xl`,`100px`],description:`Sets the maximum width of the popover. Can be a predefined size or a custom CSS value.`,table:{defaultValue:{summary:`s`},type:{summary:` "reference" | "screen" | "xxs" | "xs" | "s" | "m" | "l" | "xl" | string`}}},role:{control:{type:`text`},description:`The ARIA role attribute for the popover element.`,table:{defaultValue:{summary:`dialog`},type:{summary:`string`}}},"aria-label":{control:{type:`text`},description:`The ARIA label attribute for the popover element.`,table:{defaultValue:{summary:`popover`},type:{summary:`string`}}},forceMount:{control:{type:`boolean`},description:`If true, the popover will be rendered in the DOM even when it's not open.`,table:{defaultValue:{summary:`false`},type:{summary:`boolean`}}},onMount:{control:!1,description:`This callback is called multiple times controlled by react itself under the reference callback. Helpful to manage react state or query HTML elements.`,table:{type:{summary:`(reference?: HTMLElement, floating?: HTMLElement) => void;`}}},tree:{control:{type:`boolean`},description:`If true, the popover will be able to manage popover in popover.`,table:{defaultValue:{summary:`false`},type:{summary:`boolean`}}},p:{control:{type:`select`},options:[void 0,`0`,`xxs`,`xs`,`s`,`m`,`l`,`xl`,`xxl`,`3xl`],description:`Sets padding on all sides of the popover.`,table:{defaultValue:{summary:void 0},type:{summary:` "0" | "xs" | "s" | "m" | "l" | "xl" | "xxl" | "3xl"`}}}},D.px=D.p,D.py=D.p,D.pt=D.p,D.pr=D.p,D.pb=D.p,D.pl=D.p})),k=e({AnchorAPI:()=>R,AnchorPositionAPI:()=>z,CustomDropdown:()=>L,Nested:()=>B,Playground:()=>I,PopoverWithList:()=>H,VisualTest:()=>V,__namedExportsOrder:()=>U,default:()=>N}),A,j,M,N,P,F,I,L,R,z,B,V,H,U,W=t((()=>{A=n(r()),T(),o(),O(),f(),j=i(),{fn:M}=__STORYBOOK_MODULE_TEST__,N={title:`Components/Popover`,component:p,argTypes:{...D}},P=m(`font-body-s`,`text-default`),F={chromatic:{disableSnapshot:!0}},I={render:({demoContainerHeight:e,demoContainerWidth:t,demoContentHeight:n,demoContentWidth:r,content:i,...o})=>(0,j.jsx)(`div`,{className:m(`flex`,`border-box`,`flex-col`,`items-center`,`justify-center`),style:{inlineSize:t,blockSize:e},children:(0,j.jsx)(p,{...o,content:(0,j.jsx)(`div`,{style:{blockSize:n,inlineSize:r},children:i}),p:`xl`,pb:`m`,children:(0,j.jsx)(a,{label:`My trigger`})})}),args:{demoContainerWidth:400,demoContainerHeight:400,demoContentWidth:100,demoContentHeight:100,content:`content string`,placement:`bottom-start`,onOpenChange:M(),initialOpen:!0,minWidth:`reference`,placementUpdate:!1},argTypes:{...E,...D},parameters:F},L={render:e=>(0,j.jsx)(`div`,{className:m(`flex`,`flex-col`,`p-xl`,`gap-xl`),style:{inlineSize:`400px`},children:(0,j.jsx)(p,{...e,minWidth:`reference`,content:(0,j.jsxs)(d,{children:[(0,j.jsx)(c,{onClick:()=>{},children:`Item 1`}),(0,j.jsx)(c,{onClick:()=>{},children:`Item 1`})]}),children:(0,j.jsx)(a,{label:`My trigger`,asDropdown:!0})})}),args:{},argTypes:{...D},parameters:F},R={render:e=>{let[t,n]=(0,A.useState)(),[r,i]=(0,A.useState)(!1);return(0,j.jsxs)(`div`,{className:m(`flex`,`flex-col`,`gap-xl`),style:{inlineSize:`400px`},children:[(0,j.jsx)(a,{label:`My trigger`,ref:e=>{n(e)},onClick:()=>{i(!r)}}),(0,j.jsx)(p,{...e,anchorEl:t,open:r,onOpenChange:i,content:(0,j.jsx)(`p`,{className:P,children:`placeholder`})})]})},args:{minWidth:`reference`},argTypes:{...D},parameters:F},z={render:e=>{let[t,n]=(0,A.useState)(),[r,i]=(0,A.useState)(!1);return(0,j.jsxs)(`div`,{className:m(`flex`,`flex-col`,`gap-xl`),style:{inlineSize:`400px`},children:[(0,j.jsx)(s.Trigger,{menu:(0,j.jsx)(s.Item,{label:`Delete`,onClick:e=>{n({top:e.clientY,left:e.clientX}),i(!r)}}),children:(0,j.jsx)(a,{label:`OpenMenu`,asDropdown:!0})}),(0,j.jsx)(p,{...e,anchorPosition:t,p:`m`,open:r,onOpenChange:i,content:(0,j.jsxs)(`form`,{className:m(`flex`,`flex-col`,`gap-m`,`items-start`,`bg-default`),onSubmit:e=>{e.preventDefault()},children:[(0,j.jsx)(`h2`,{className:m(`flex`,`text-default`,`font-heading-s`),children:`Delete confirmation`}),(0,j.jsx)(l,{severity:`warning`,children:`This action can't be reverted`}),(0,j.jsx)(`div`,{className:m(`flex`,`flex-col`,`gap-m`,`w-full`,`items-end`),children:(0,j.jsx)(a,{variant:`primary`,label:`Yes`,type:`submit`})})]})})]})},args:{minWidth:`reference`},argTypes:{...D},parameters:F},B={render:()=>(0,j.jsx)(`div`,{className:m(`flex`,`flex-col`,`gap-xl`,`p-xl`,`items-center`,`justify-center`),style:{inlineSize:`400px`,blockSize:`300px`},children:(0,j.jsx)(p,{tree:!0,p:`xl`,placement:`top`,content:(0,j.jsx)(p,{content:`Nested content`,p:`xl`,placement:`right`,children:(0,j.jsx)(`button`,{type:`button`,children:`Nested reference`})}),children:(0,j.jsx)(`button`,{type:`button`,children:`Root reference`})})}),parameters:F},V={render:()=>{let[e,t]=(0,A.useState)(!1);return(0,A.useEffect)(()=>{let e=setTimeout(()=>{t(!0)},50);return()=>{clearTimeout(e)}},[]),(0,j.jsxs)(`div`,{className:m(`flex`,`flex-row`,`p-xl`,`items-center`,`justify-between`,`w-full`),style:{blockSize:`100vh`},children:[(0,j.jsx)(`div`,{className:m(`flex`,`flex-row`,`justify-end`),style:{inlineSize:`35%`},children:(0,j.jsx)(p,{initialOpen:!0,placement:`left`,content:(0,j.jsx)(`p`,{className:P,children:`placeholder`}),children:(0,j.jsx)(a,{label:`left`})})}),(0,j.jsxs)(`div`,{className:m(`flex`,`flex-col`,`self-center`,`gap-3xl`,`items-center`),style:{inlineSize:`30%`},children:[(0,j.jsx)(p,{initialOpen:!0,placement:`top`,content:(0,j.jsx)(`p`,{className:P,children:`placeholder`}),children:(0,j.jsx)(a,{label:`top`})}),(0,j.jsx)(p,{initialOpen:!0,placement:`bottom`,content:(0,j.jsx)(`p`,{className:P,children:`placeholder`}),children:(0,j.jsx)(a,{label:`bottom`})})]}),(0,j.jsx)(`div`,{style:{inlineSize:`35%`},children:(0,j.jsx)(p,{initialOpen:!0,placement:`right`,content:(0,j.jsx)(`p`,{className:P,children:`placeholder`}),children:(0,j.jsx)(a,{label:`right`})})}),(0,j.jsx)(`div`,{style:{inlineSize:`35%`},children:(0,j.jsx)(p,{tree:!0,p:`xl`,placement:`top`,initialOpen:!0,content:(0,j.jsx)(p,{content:`Nested content`,p:`xl`,placement:`left`,open:e,onOpenChange:t,children:(0,j.jsx)(`button`,{type:`button`,className:P,children:`Nested reference`})}),children:(0,j.jsx)(`button`,{type:`button`,className:P,children:`Root reference`})})})]})},parameters:{controls:{disable:!0}}},H={render:e=>(0,j.jsxs)(`div`,{className:m(`bg-default`,`text-default`),children:[(0,j.jsx)(`p`,{children:`This is a demo of how to build keyboard navigation in a popover`}),(0,j.jsx)(p,{...e,content:(0,j.jsx)(S,{children:(0,j.jsxs)(d,{useGesture:!0,children:[(0,j.jsx)(c,{selected:!0,onClick:()=>{},children:(0,j.jsx)(u,{label:`select item 1`})}),(0,j.jsx)(c,{onClick:()=>{},children:(0,j.jsx)(u,{label:`select item 2`})}),(0,j.jsx)(g,{}),(0,j.jsxs)(c,{onClick:()=>{},children:[(0,j.jsx)(h,{}),`Inbox`]}),(0,j.jsxs)(c,{onClick:()=>{},children:[(0,j.jsx)(_,{}),`Draft`]}),(0,j.jsxs)(c,{disabled:!0,onClick:()=>{},children:[(0,j.jsx)(_,{}),`Disabled`]})]})}),p:`xl`,pb:`m`,children:(0,j.jsx)(a,{label:`My trigger`})})]}),parameters:F},I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
  render: ({
    demoContainerHeight,
    demoContainerWidth,
    demoContentHeight,
