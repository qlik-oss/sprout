...
Note: Custom labels in mark objects take precedence over this formatting.`,table:{type:{summary:`(value: number) => ReactNode`},defaultValue:{summary:`undefined`}}}},o={...a,defaultValue:{control:`number`,defaultValue:{summary:`min`},table:{type:{summary:`number`}}},inputRef:{control:!1,description:`A ref to the underlying input element.`,table:{type:{summary:`Ref<HTMLInputElement>`}}},value:{control:`number`,table:{type:{summary:`number`}}},onChange:{control:!1,description:`Callback fired when the slider value changes. Receives the new value and the triggering event.`,table:{type:{summary:`(value: number, event: Event) => void`}}},onChangeCommitted:{control:!1,description:"Callback function that is fired when the `pointerup` is triggered.",table:{type:{summary:`(value: number, event: Event) => void`}}}},s={...a,defaultValue:{control:`object`,description:`An array of numbers representing the default range. If not provided, the slider will default to using [min, max]. Only the first two values will be used, additional values will be ignored.`,table:{defaultValue:{summary:`[min, max]`},type:{summary:`number[]`}}},endInputRef:{control:!1,description:`A ref to the end grip's underlying input element.`,table:{type:{summary:`Ref<HTMLInputElement>`}}},endName:{control:`text`,description:`The name attribute for the end grip's input element.`,table:{type:{summary:`string`}}},value:{control:`object`,description:`An array of numbers representing the current range value. Only the first two values will be used, additional values will be ignored.`,table:{type:{summary:`number[]`}}},onChange:{control:!1,description:"Callback fired when either grip value changes. Receives a `number[]` (only the first two values will be used), the triggering event, and the index of the active grip.",table:{type:{summary:`(value: number[], event: Event, activeGripIndex: number) => void`}}},onChangeCommitted:{control:!1,description:"Callback function that is fired when the `pointerup` is triggered.",table:{type:{summary:`((value: number[], event: Event) => void`}}},startInputRef:{control:!1,description:`A ref to the start grip's underlying input element.`,table:{type:{summary:`Ref<HTMLInputElement>`}}},startName:{control:`text`,description:`The name attribute for the start grip's input element.`,table:{type:{summary:`string`}}}}})),l,u,d,f,p,m,h=e((()=>{r(),c(),l=i(),u={title:`Components/Slider`,component:t.Single,parameters:{}},d={render:e=>(0,l.jsx)(`div`,{className:n(`w-s`),children:(0,l.jsx)(t.Single,{...e})}),args:{label:`Slider single`,defaultValue:50,min:0,max:100,step:1,orientation:`horizontal`},argTypes:o,parameters:{chromatic:{disableSnapshot:!0}}},f={render:e=>(0,l.jsx)(`div`,{className:n(`w-s`),children:(0,l.jsx)(t.Range,{...e})}),args:{label:`Slider range`,defaultValue:[20,80],min:0,max:100,step:1,orientation:`horizontal`},argTypes:s,parameters:{chromatic:{disableSnapshot:!0}}},p={render:()=>(0,l.jsxs)(`div`,{className:n(`flex`,`flex-row`,`gap-xxl`),children:[(0,l.jsxs)(`div`,{className:n(`flex`,`flex-col`,`gap-l`,`w-xs`),children:[(0,l.jsx)(t.Single,{defaultValue:50,label:`Default`}),(0,l.jsx)(t.Single,{defaultValue:50,label:`Hover`,"data-testid":`hover`}),(0,l.jsx)(t.Single,{defaultValue:50,label:`Focus`,"data-testid":`focusVisible`}),(0,l.jsx)(t.Single,{defaultValue:50,label:`Disabled`,disabled:!0}),(0,l.jsx)(t.Single,{defaultValue:50,label:`With mark labels`,marks:[{value:0,label:`Min`},{value:25},{value:50,label:`Mid`},{value:75},{value:100,label:`Max`}],markLabels:!0}),(0,l.jsx)(t.Single,{defaultValue:50,label:`Vertical mark labels`,step:10,marks:!0,markLabels:!0,verticalMarkLabels:!0,valueLabelFormat:e=>`${e}%`}),(0,l.jsx)(t.Single,{defaultValue:50,label:`With helper text`,helpText:`Use the slider to choose a value within the allowed range`}),(0,l.jsx)(t.Single,{defaultValue:50,label:`With error`,errorMessages:[`This is an error`]})]}),(0,l.jsxs)(`div`,{className:n(`flex`,`flex-col`,`gap-l`,`w-xs`),children:[(0,l.jsx)(t.Range,{label:`Range`,defaultValue:[49,50]}),(0,l.jsx)(t.Range,{label:`Range with marks`,defaultValue:[30,70],step:10,marks:!0}),(0,l.jsx)(t.Range,{label:`Range custom min/max`,min:100,max:600,defaultValue:[200,470]}),(0,l.jsx)(t.Range,{label:`Range with optional`,defaultValue:[40,70],optional:!0,infoIconTooltip:`Info icon tooltip`})]}),(0,l.jsxs)(`div`,{className:n(`flex`,`flex-row`,`gap-l`),children:[(0,l.jsx)(t.Single,{defaultValue:50,label:`Vertical`,orientation:`vertical`}),(0,l.jsx)(t.Range,{label:`Vertical Range`,orientation:`vertical`,defaultValue:[49,50]}),(0,l.jsx)(t.Single,{defaultValue:50,label:`Vertical with marks`,orientation:`vertical`,helpText:`Helper text`,marks:[{value:0,label:`0`},{value:25},{value:50,label:`50`},{value:75},{value:100,label:`100`}]}),(0,l.jsx)(t.Range,{label:`Vertical with error`,orientation:`vertical`,defaultValue:[20,80],errorMessages:[`This is an error`]})]})]}),parameters:{controls:{disable:!0},pseudo:{hover:`[data-testid="hover"] [role="presentation"] [role="presentation"]`,focusVisible:`[data-testid="focusVisible"] input[type="range"]`}}},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
