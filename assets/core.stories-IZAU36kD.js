import{r,j as e}from"./iframe-BQJExRCF.js";import{s}from"./sprout-DxA14K3u.js";import{F as g,a as h}from"./Next-BCf902gw.js";import{I as l}from"./Content-DvZzG0Vr.js";import{B as v}from"./Button-C7-D-GN_.js";import{c as d}from"./classNames-B0wfWtWT.js";import"./preload-helper-PPVm8Dsz.js";import"./icons-CzMI2h-K.js";import"./Button.module-C2ELNEem.js";import"./Badge-B9--3FkB.js";import"./Tooltip-CVFOQrqK.js";import"./sprout-tokens-D9QRO1qB.js";import"./renderOrClone-DAgGzV0n.js";import"./useId-Drz8gmS2.js";import"./ProgressCircular-B4mHH4_Y.js";import"./useI18n-B99T9obj.js";const N={get:{control:!1,description:"Gets the data structure you want based on viewport sizes. It's a generic method so you need to specify the type when calling it.",table:{type:{summary:"({ s, m, l, xl }: Partial<Record<ViewportSize, T>>) => T | undefined"}}},classNames:{control:!1,description:"An extension of sprout.classNames to support viewport based classNames.",table:{type:{summary:"(options: ViewportOptions<AllClasses[] | AllClasses>, className?: string) => string"}}},addListener:{description:"Integrates sprout.media with your framework reactivity system. It's based on the native matchMedia API.",table:{type:{summary:"(viewportSize: ViewportSize) => void"}}},removeListeners:{description:"Removes all listeners added with addListener.",table:{type:{summary:"() => void"}}},getViewportSize:{control:!1,description:"Returns the current viewport size based on the system definition of it.",table:{type:{summary:"() => ViewportSize"}}}},w=s.media.getViewportSize(),W={title:"CSS/sprout-css-modules/core"},p={name:"responsive / media",parameters:{controls:!1,layout:"fullscreen"},argTypes:N,render:(n,t)=>{const[m,a]=r.useState(w);return r.useEffect(()=>(s.media.addListener(a),()=>{s.media.removeListeners()}),[t]),e.jsx("div",{className:s.classNames("border-box","p-m"),children:e.jsxs("div",{className:s.media.classNames({s:"gap-xl",m:"gap-xl",l:"gap-xxl",xl:"gap-3xl"},s.classNames("grid","grid-cols-16")),children:[e.jsx("div",{className:s.media.classNames({s:["col-start-1","col-span-3"],m:["col-start-2","col-span-3"],l:["col-start-3","col-span-3"],xl:["col-start-4","col-span-3"]}),children:e.jsx(l,{children:s.media.get({s:["col-start-1","col-span-3"].join(", "),m:["col-start-2","col-span-3"].join(", "),l:["col-start-3","col-span-3"].join(", "),xl:["col-start-4","col-span-3"].join(", ")})})}),e.jsx("div",{className:s.classNames("col-start-14","col-end-16"),children:e.jsx(l,{children:"end"})}),e.jsx("div",{className:s.media.classNames({s:["col-span-8"],m:["col-span-4"]}),children:e.jsx(l,{children:"s=8 m=4"})}),e.jsx("div",{className:s.media.classNames({s:["col-span-8"],m:["col-span-4"]}),children:e.jsx(l,{children:"s=8 m=4"})}),e.jsx("div",{className:s.media.classNames({s:["col-span-16"],m:["col-span-8"]}),children:e.jsx(l,{children:"s=16 m=8"})}),e.jsx("div",{className:s.classNames("col-span-16"),...s.media.get({s:{"data-viewport":"s"}}),children:e.jsxs(l,{children:['sprout.media.get can return anything even object / props {data-viewport="',s.media.getViewportSize(),'" } !']})})]})})}},x={name:"createContainer",parameters:{controls:!1,chromatic:{modes:{breakpoint_xxs:{viewport:"mobile1"},breakpoint_xs:{viewport:"mobile2"},breakpoint_m:{viewport:"tablet"}}}},render:()=>{const n=r.useRef(null),[t,m]=r.useState("xxs"),a=r.useRef(null),o=r.useMemo(()=>s.createContainer(t,n.current),[t]);return r.useEffect(()=>{const c=s.widthObserver(()=>n.current,{boxSizing:"border-box",onResize:i=>{if(typeof i>"u")return;const f=o.match(i);a.current!==f&&(a.current=f,m(f))}});return c.observe(),()=>{c.disconnect()}},[o]),e.jsxs("div",{className:s.classNames("flex","border-box","flex-col","gap-m","w-full"),children:[e.jsxs("p",{className:s.classNames("font-body-s","text-default"),children:["This example changes alignment and layout based on the element’s own width using ",e.jsx("code",{children:"widthObserver"})," together with"," ",e.jsx("code",{children:"createContainer"})," and ",e.jsx("code",{children:"get"}),". Drag the handle to resize or change the viewport size."]}),e.jsxs("div",{ref:n,className:s.classNames("border-box","border-default","p-m","w-full"),style:{resize:"horizontal",overflow:"auto"},children:[e.jsx("div",{className:s.classNames("border-box","p-m"),children:e.jsx(v,{label:`Button - ${o.get({xs:"justified: true",m:"justified: false"})}`,justified:o.get({xxs:!0,m:!1})})}),e.jsx("div",{className:o.classNames({xxs:["grid-cols-1","gap-s"],xs:["grid-cols-2","gap-s"],s:["grid-cols-3","gap-m"],m:["grid-cols-4","gap-m"],l:["grid-cols-5","gap-l"],xl:["grid-cols-6","gap-l"],xxl:["grid-cols-7","gap-xl"],"3xl":["grid-cols-8","gap-xl"],"4xl":["grid-cols-9","gap-xl"]},s.classNames("grid","border-box","p-m")),children:Array.from({length:9}).map((c,i)=>e.jsxs("div",{className:s.classNames("border-default","p-s","items-center","justify-center","flex"),children:["Item ",i+1]},i))})]})]})}},u={name:"widthObserver",parameters:{controls:!1},render:()=>{const n=r.useRef(null),[t,m]=r.useState(void 0),[a,o]=r.useState("content-box");return r.useEffect(()=>{const c=s.widthObserver(()=>n.current,{boxSizing:a,onResize:i=>{m(i)}});return c.observe(),()=>{c.disconnect()}},[a]),e.jsxs("div",{className:s.classNames("flex","border-box","flex-col","gap-m","w-full"),style:{alignItems:"flex-start"},children:[e.jsxs("p",{className:s.classNames("font-body-s","text-default"),children:["Resize the element horizontally, its own width (not the viewport) is observed via ",e.jsx("code",{children:"ResizeObserver"}),"."]}),e.jsx(v,{label:a==="border-box"?"Switch to content-box":"Switch to border-box",onClick:()=>{o(a==="border-box"?"content-box":"border-box")}}),e.jsxs("div",{ref:n,className:s.classNames("border-default","bg-default","p-m","w-m"),style:{resize:"horizontal",overflow:"auto"},children:[e.jsxs(l,{children:["width: ",typeof t=="number"?`${Math.round(t)}px`:"—"]}),e.jsxs("div",{className:s.classNames("font-label-s","text-default","pt-s"),children:["box: ",a]})]})]})}},z=[{dir:"ltr",styles:["rtl_rotate_y_180"]},{dir:"rtl",styles:["rtl_rotate_y_180"]}],b={name:"rtl",parameters:{controls:!1},render:()=>e.jsx("div",{className:s.classNames("flex","flex-col","bg-default","text-default","gap-3xl","w-m","p-m"),children:z.map(({dir:n,styles:t})=>e.jsxs("div",{dir:n,className:d("flex","flex-col","border-box","border-default","p-m","gap-m"),children:[e.jsxs("span",{children:[n," ",t.join(" ")]}),e.jsxs("div",{className:d("flex","flex-row","border-box","gap-m"),children:[e.jsx(g,{className:d(...t)})," ","NextIcon"]}),e.jsxs("div",{className:d("flex","flex-row","border-box","gap-m"),children:[e.jsx(h,{className:d(...t)}),"AlignLeftIcon"]})]},n))})};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
