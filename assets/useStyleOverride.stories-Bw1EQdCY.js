import{r as p,j as m}from"./iframe-CYyT-rNd.js";import{t as l}from"./sprout-tokens-D9QRO1qB.js";import{t as s}from"./sprout-tokens-DrATkuH6.js";import{u as y}from"./useId-BEfewr8x.js";import"./preload-helper-PPVm8Dsz.js";const S=Object.keys(l);function _(e){return S.includes(e)}function g(e){return Object.keys(e).filter(_)}function i(e){document.querySelector(`#${e}`)?.remove()}function k(e,o="body"){const r=y().replace(/:/g,"_");return p.useLayoutEffect(()=>{i(r);const t=g(e),c=document.createElement("style");c.id=r;const u=[];for(const a of t){const f=e[a];u.push(`  --sprout-${a.replace(/_/g,"-")}: ${f};
`)}c.innerText=`${o} {
${u.join("")}}
