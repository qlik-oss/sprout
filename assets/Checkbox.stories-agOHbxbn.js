import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-BDsysHVl.js";import{n as r,t as i}from"./sprout-DO5zX6cp.js";import{Mt as a,ki as o,t as s,wt as c}from"./sprout-react-KA55n9ke.js";import{t as l}from"./jsx-runtime-Bq1bXGty.js";import{n as u,r as d}from"./Field.argTypes-DxB8lHKE.js";var f,p,m=t((()=>{d(),f={checked:{control:{type:`boolean`},description:`If true, the checkbox is checked.`,table:{type:{summary:`boolean`}}},defaultChecked:{control:{type:`boolean`},description:`If true, the checkbox is checked by default (uncontrolled).`,table:{type:{summary:`boolean`}}},disabled:{control:{type:`boolean`},description:`If true, the checkbox is disabled.`,table:{type:{summary:`boolean`}}},helpText:{control:{type:`text`},description:`Additional help text displayed below the checkbox.`,table:{type:{summary:`string`}}},indeterminate:{control:{type:`boolean`},description:`If true, the checkbox is in an indeterminate state (controlled).`,table:{type:{summary:`boolean`}}},infoIconTooltip:u.infoIconTooltip,label:{control:{type:`text`},description:`The label text displayed next to the checkbox.`,table:{type:{summary:`string`}}},name:{control:{type:`text`},description:`The name attribute for the checkbox input.`,table:{type:{summary:`string`}}},onChange:{control:!1,description:`Callback function invoked when the checkbox state changes.`,table:{type:{summary:`(event: ChangeEvent<HTMLInputElement>) => void`}}}},p={...u,children:{control:!1,description:`Checkbox components to be rendered inside the group.`,table:{type:{summary:`ReactNode`}}},isError:{control:{type:`boolean`},description:`If true, the checkbox group is displayed in an error state.`,table:{type:{summary:`boolean`}}},options:{control:!1,description:`Array of checkbox options to render within the group.`,table:{type:{summary:`CheckboxProps[]`}}}}})),h,g,_,v,y,b,x,S,C,w,T=t((()=>{h=e(n()),i(),s(),m(),g=l(),{fn:_}=__STORYBOOK_MODULE_TEST__,v={title:`Components/Checkbox`,component:a},y={render:e=>(0,g.jsx)(a,{...e}),args:{name:`checkbox`,label:`Checkbox`},argTypes:f,parameters:{chromatic:{disableSnapshot:!0}}},b={render:({onChange:e,...t})=>{let[n,i]=(0,h.useState)(!1),s=t=>{i(t.target.checked),e&&e(t)};return(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(`div`,{"data-testid":`wrapper`,className:o(`flex`,`flex-row`,`border-box`,`p-s`,`w-fit`),children:(0,g.jsx)(a,{...t,checked:n,onChange:s})}),(0,g.jsxs)(`p`,{className:r.classNames(`font-body-s`,`text-default`),children:[`Checked: `,n?`true`:`false`]})]})},args:{name:`checkbox`,label:`Checkbox`,onChange:_(),disabled:!1},argTypes:f,parameters:{chromatic:{disableSnapshot:!0}}},x={render:e=>(0,g.jsx)(`div`,{"data-testid":`wrapper`,className:o(`flex`,`flex-row`,`border-box`,`p-s`,`items-start`,`gap-m`,`w-fit`),children:(0,g.jsx)(c,{...e,options:[{name:`q1`,label:`Option 1`},{name:`q2`,label:`Option 2`},{name:`q3`,label:`Option 3`}]})}),args:{helpText:`Help text`,label:`Checkbox Group`},argTypes:p,parameters:{chromatic:{disableSnapshot:!0}}},S={render:()=>{let[e,t]=(0,h.useState)([!0,!1]);return(0,g.jsxs)(`div`,{"data-testid":`wrapper`,className:o(`flex`,`flex-col`,`border-box`,`p-s`,`gap-m`,`w-fit`),children:[(0,g.jsx)(a,{label:`Parent`,checked:e[0]?e[1]:void 0,indeterminate:e[0]!==e[1],onChange:e=>{t([e.target.checked,e.target.checked])}}),(0,g.jsxs)(`div`,{className:o(`flex`,`flex-col`,`border-box`,`pl-m`,`items-start`,`gap-m`),children:[(0,g.jsx)(a,{label:`Child 1`,checked:e[0],onChange:n=>{t([n.target.checked,e[1]])}}),(0,g.jsx)(a,{label:`Child 2`,checked:e[1],onChange:n=>{t([e[0],n.target.checked])}})]})]})},parameters:{controls:{disable:!0},chromatic:{disableSnapshot:!0}}},C={render:()=>(0,g.jsxs)(`div`,{className:o(`flex`,`flex-col`,`border-box`),children:[(0,g.jsx)(`h2`,{className:r.classNames(`font-heading-m`,`text-default`),children:`States`}),(0,g.jsxs)(`div`,{className:o(`flex`,`flex-row`,`border-box`,`justify-stretch`,`gap-m`),children:[(0,g.jsxs)(`div`,{className:o(`flex`,`flex-col`,`border-box`,`gap-m`,`justify-stretch`),children:[(0,g.jsx)(a,{name:`checkbox1`,label:`Uncheck default`}),(0,g.jsx)(a,{name:`checkbox1`,label:`Uncheck hover`,"data-testid":`hover`}),(0,g.jsx)(a,{name:`checkbox1`,label:`Uncheck focus`,"data-testid":`focus`}),(0,g.jsx)(a,{name:`checkbox4`,label:`Uncheck disabled`,disabled:!0})]}),(0,g.jsxs)(`div`,{className:o(`flex`,`flex-col`,`border-box`,`gap-m`,`justify-stretch`),children:[(0,g.jsx)(a,{name:`checkbox2`,label:`Indeterminate default`,indeterminate:!0}),(0,g.jsx)(a,{name:`checkbox2`,label:`Indeterminate hover`,indeterminate:!0,"data-testid":`hover`}),(0,g.jsx)(a,{name:`checkbox3`,label:`Indeterminate focus`,indeterminate:!0,"data-testid":`focus`}),(0,g.jsx)(a,{name:`checkbox5`,label:`Indeterminate disabled`,indeterminate:!0,disabled:!0})]}),(0,g.jsxs)(`div`,{className:o(`flex`,`flex-col`,`border-box`,`gap-m`,`justify-stretch`),children:[(0,g.jsx)(a,{name:`checkbox3`,label:`Checked default`,checked:!0}),(0,g.jsx)(a,{name:`checkbox3`,label:`Checked hover`,checked:!0,"data-testid":`hover`}),(0,g.jsx)(a,{name:`checkbox3`,label:`Checked focus`,checked:!0,"data-testid":`focus`}),(0,g.jsx)(a,{name:`checkbox6`,label:`Checked disabled`,checked:!0,disabled:!0})]})]}),(0,g.jsx)(`h2`,{className:r.classNames(`font-heading-m`,`text-default`),children:`Tooltip and help text`}),(0,g.jsx)(`div`,{className:o(`flex`,`flex-row`,`border-box`,`justify-stretch`,`gap-m`),children:(0,g.jsxs)(`div`,{className:o(`flex`,`flex-col`,`border-box`,`gap-m`,`justify-stretch`),children:[(0,g.jsx)(a,{name:`checkbox1`,label:`Uncheck tooltip`,infoIconTooltip:`This is some additional info about this checkbox`}),(0,g.jsx)(a,{name:`checkbox1`,label:`Unchecked with help text and tooltip`,helpText:`This is some help text for this checkbox`,infoIconTooltip:`This is some additional info about this checkbox`}),(0,g.jsx)(a,{name:`checkbox1`,checked:!0,label:`Checked with help text and tooltip`,helpText:`This is some help text for this checkbox`,infoIconTooltip:`This is some additional info about this checkbox`}),(0,g.jsx)(a,{name:`checkbox1`,disabled:!0,label:`Disabled uncheck tooltip`,infoIconTooltip:`This is some additional info about this checkbox`}),(0,g.jsx)(a,{name:`checkbox1`,disabled:!0,label:`Disabled unchecked with help text and tooltip`,helpText:`This is some help text for this checkbox`,infoIconTooltip:`This is some additional info about this checkbox`}),(0,g.jsx)(a,{name:`checkbox1`,checked:!0,disabled:!0,label:`Disabled checked with help text and tooltip`,helpText:`This is some help text for this checkbox`,infoIconTooltip:`This is some additional info about this checkbox`})]})}),(0,g.jsx)(`h2`,{className:r.classNames(`font-heading-m`,`text-default`),children:`Field`}),(0,g.jsx)(`div`,{"data-testid":`wrapper`,className:o(`flex`,`flex-col`,`border-box`,`p-s`,`gap-m`,`w-fit`),children:(0,g.jsx)(c,{label:`Checkbox group`,helpText:`help me`,options:[{name:`q1`,label:`Option 1`},{name:`q2`,label:`Option 2`},{name:`q3`,label:`Option 3`}]})}),(0,g.jsx)(`h2`,{className:r.classNames(`font-heading-m`,`text-default`),children:`Label overflow`}),(0,g.jsxs)(`div`,{className:o(`flex`,`flex-col`,`border-box`,`gap-m`),style:{inlineSize:200},children:[(0,g.jsx)(a,{label:`Long label that wraps over to a new row`,name:`overflow`}),(0,g.jsx)(a,{label:`Longlabelthatwrapsovertoanewrow`,name:`overflow`}),(0,g.jsx)(a,{label:`Automatically flag outdated records and queue them for clean-up during the nightly maintenance job`,name:`overflow`}),(0,g.jsx)(a,{label:`Maintain a full audit log of field-level changes so that analysts can reconstruct the exact record state at any point in time`,name:`overflow`}),(0,g.jsx)(a,{label:`/data/warehouse/customers/archived/2025/region/eu-west/segment/high-value/records`,name:`overflow`}),(0,g.jsx)(a,{label:`Enable supercalifragilisticexpialidocious mode for enhanced performance and reliability`,name:`overflow`,infoIconTooltip:`This is some additional info about this checkbox`})]}),(0,g.jsx)(`h2`,{className:r.classNames(`font-heading-m`,`text-default`),children:`Helper text`}),(0,g.jsxs)(`div`,{className:o(`flex`,`flex-col`,`border-box`,`gap-m`),style:{inlineSize:200},children:[(0,g.jsx)(a,{label:`Enable dark mode`,name:`helptext`,helpText:`Activates dark mode theme for less eye strain`}),(0,g.jsx)(a,{label:`Enable dark mode`,name:`helptext`,helpText:`Anim cupidatat ex ad voluptate sit occaecat deserunt minim cupidatat ipsum exercitation ex veniam cupidatat. Incididunt culpa dolore duis commodo.`})]})]}),parameters:{controls:{disable:!0},pseudo:{hover:`[data-testid="hover"]`,focusVisible:`[data-testid="focus"]`}}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
