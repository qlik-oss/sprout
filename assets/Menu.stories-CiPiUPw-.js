import{j as e,r as p}from"./iframe-lMEil1TA.js";import{F as g,a as C}from"./settings-oS6F6h_p.js";import{F as M}from"./delete-CG-UgknF.js";import{F as I}from"./edit-Bij8o67D.js";import{F as h,a as w}from"./person-6TmEe_Ks.js";import{M as l}from"./Menu-BuAoSxI5.js";import{B as c}from"./Button-B3VC5XuI.js";import{c as o}from"./classNames-B_Twdkca.js";const{fn:_}=__STORYBOOK_MODULE_TEST__,S={title:"Components/Menu",component:l.Trigger},b={chromatic:{disableSnapshot:!0}},s={render:()=>e.jsx(l.Trigger,{menu:e.jsxs(e.Fragment,{children:[e.jsx(l.GroupLabel,{label:"User"}),e.jsx(l.Item,{icon:e.jsx(h,{}),label:"Profile",disabled:!0}),e.jsx(l.Item,{icon:e.jsx(w,{}),label:"Logout"}),e.jsx(l.Item,{icon:null,label:"Reload"}),e.jsx(l.Item,{icon:null,label:"Share"}),e.jsx(l.Sub,{icon:e.jsx(g,{}),label:"Settings",menu:e.jsxs(e.Fragment,{children:[e.jsx(l.Item,{label:"Text"}),e.jsx(l.Item,{label:"Video"}),e.jsx(l.Sub,{label:"Image",menu:e.jsxs(e.Fragment,{children:[e.jsx(l.Item,{label:".png"}),e.jsx(l.Item,{label:".jpg"}),e.jsx(l.Item,{label:".svg"}),e.jsx(l.Item,{label:".gif"})]})})]})}),e.jsx(l.Sub,{icon:e.jsx(C,{}),label:"More options",menu:e.jsxs(e.Fragment,{children:[e.jsx(l.Item,{label:"Reload"}),e.jsx(l.Item,{label:"Schedule"}),e.jsx(l.Item,{label:"History"})]})}),e.jsx(l.Divider,{}),e.jsx(l.Item,{icon:e.jsx(I,{}),label:"Edit",description:"Don’t remember what we said about overflow, but this would be it.",valueLabel:"⌘ E"}),e.jsx(l.Item,{icon:e.jsx(M,{}),label:"Delete"}),e.jsx(l.Divider,{}),e.jsx(l.Item,{icon:null,label:"Cut",valueLabel:"⌘ X"}),e.jsx(l.Item,{icon:null,label:"Copy",valueLabel:"⌘ C"}),e.jsx(l.Item,{icon:null,label:"Paste",disabled:!0,valueLabel:"⌘ V"})]}),children:e.jsx(c,{label:"Open Menu"})}),parameters:{...b}},r={render:()=>e.jsx(l.Trigger,{defaultOpen:!0,menu:e.jsxs(e.Fragment,{children:[e.jsx(l.Item,{label:"Bold",selectable:!0}),e.jsx(l.Item,{label:"Italic",selectable:!0,selected:!0}),e.jsx(l.Item,{label:"Underline",selectable:!0}),e.jsx(l.Divider,{}),e.jsx(l.Item,{label:"Small",selectable:!0}),e.jsx(l.Item,{label:"Medium",selectable:!0}),e.jsx(l.Item,{label:"Large",selectable:!0})]}),children:e.jsx(c,{label:"Open Menu"})}),parameters:{...b}},i={render:()=>{const[a,d]=p.useState(null),[x,m]=p.useState(null),j=!!x,v=t=>{m(t.currentTarget)},f=t=>{t.preventDefault(),d(t)},n=()=>{d(null),m(null)};return e.jsxs("div",{className:o("flex","flex-row","w-full"),onContextMenu:f,style:{cursor:"context-menu"},children:[e.jsxs("div",{className:o("flex","flex-col","p-m","w-full","border-default"),"data-testid":"contextual",children:[e.jsx("h1",{className:o("flex","flex-row","border-box","font-heading-m","text-default"),children:"Contextual Menu demo using MUI api"}),e.jsx("p",{className:o("flex","flex-row","border-box","font-body-m","text-default"),children:"This a paragraph with a bit of text."}),e.jsx(c,{label:"Menu",onClick:v})]}),e.jsx(l.Contextual,{minWidth:"xxs",menu:e.jsxs(e.Fragment,{children:[e.jsx(l.Item,{onClick:n,label:"Copy"}),e.jsx(l.Item,{onClick:n,label:"Print"}),e.jsx(l.Item,{onClick:n,label:"Highlight"}),e.jsx(l.Item,{onClick:n,label:"Email"})]}),open:!!a,onOpenChange:t=>{t||d(null)},anchorPosition:a?{left:a.clientX,top:a.clientY}:void 0}),e.jsx(l.Trigger,{anchorEl:x||void 0,open:j,onOpenChange:t=>{t||m(null)},menu:e.jsxs(e.Fragment,{children:[e.jsx(l.Item,{onClick:n,label:"Copy"}),e.jsx(l.Item,{onClick:n,label:"Print"}),e.jsx(l.Item,{onClick:n,label:"Highlight"}),e.jsx(l.Item,{onClick:n,label:"Email"})]})})]})},parameters:{...b,controls:{disable:!0}}},u={render:a=>e.jsx("div",{className:o("flex","flex-row","items-start"),style:{blockSize:"650px",inlineSize:"300px"},children:e.jsx(l.Trigger,{...a,menu:e.jsxs(e.Fragment,{children:[e.jsx(l.GroupLabel,{label:"Menu.GroupLabel"}),e.jsx(l.Item,{icon:null,label:"Default"}),e.jsx(l.Divider,{}),e.jsx(l.Item,{icon:null,label:"Hover","data-testid":"hover"}),e.jsx(l.Divider,{}),e.jsx(l.Item,{icon:null,label:"Active","data-testid":"active"}),e.jsx(l.Divider,{}),e.jsx(l.Item,{icon:null,label:"Focus","data-testid":"focus"}),e.jsx(l.Divider,{}),e.jsx(l.Item,{icon:e.jsx(h,{}),label:"Disabled",disabled:!0}),e.jsx(l.Divider,{}),e.jsx(l.Item,{icon:e.jsx(I,{}),label:"Edit with a super long menu too so it should also overflow",description:"Don’t remember what we said about overflow, but this would be it.",valueLabel:"⌘ E",selectable:!0,selected:!0}),e.jsx(l.Item,{icon:null,label:"An_too_long_label_with_very_long_word_that_goes_beyond_the_parent_size_and_with_no_space",selectable:!0,valueLabel:"⌘ E"}),e.jsx(l.Item,{variant:"destructive",icon:e.jsx(M,{}),label:"Delete"}),e.jsx(l.Divider,{}),e.jsx(l.Item,{icon:null,label:"Cut",valueLabel:"⌘ X"}),e.jsx(l.Item,{icon:null,label:"Copy",valueLabel:"⌘ C"}),e.jsx(l.Item,{icon:null,label:"Paste",disabled:!0,valueLabel:"⌘ V"}),e.jsx(l.Divider,{}),e.jsx(l.Item,{label:"Bold",selectable:!0}),e.jsx(l.Item,{label:"Italic",selectable:!0,selected:!0}),e.jsx(l.Item,{label:"Underline",selectable:!0}),e.jsx(l.Divider,{}),e.jsxs(l.Split,{children:[e.jsx(l.Item,{label:"Link",selectable:!0}),e.jsx(l.SecondaryAction,{onClick:()=>{window.open("/?path=/story/components-menu--secondary-action","_blank")?.focus()}})]})]}),children:e.jsx(c,{label:"Controlled Menu"})})}),args:{open:!0,defaultOpen:!0,onOpenChange:_()},parameters:{pseudo:{hover:'[data-testid="hover"]',focusVisible:'[data-testid="focus"]',active:'[data-testid="active"]'},chromatic:{delay:100}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
