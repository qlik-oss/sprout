import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-BDsysHVl.js";import{n as r,t as i}from"./sprout-DO5zX6cp.js";import{Cr as a,Mt as o,Ur as s,Vr as c,Yr as l,gn as u,ki as d,mn as f,nn as p,q as m,r as h,si as g,t as _,ut as v,xn as y}from"./sprout-react-KA55n9ke.js";import{t as b}from"./jsx-runtime-Bq1bXGty.js";import{n as x,r as S,t as C}from"./Icons-DyWhpT2j.js";import{n as w,t as T}from"./lib-DixHylf7.js";var E,D,O=t((()=>{_(),S(),E=b(),D={id:{control:`text`,description:`Unique identifier for the tree item.`,table:{type:{summary:`string`}}},label:{control:`text`,description:`The label of the tree item.`,table:{type:{summary:`string`}}},path:{control:`object`,description:`An array representing the path to the tree item, used for nesting.`,table:{type:{summary:`string[]`}}},isLeaf:{control:`boolean`,description:`Indicates if the tree item is a leaf node (no children).`,table:{type:{summary:`boolean`}}},disabled:{control:`boolean`,description:`Disables the tree item and prevents user interaction.`,table:{type:{summary:`boolean`}}},nesting:{control:`number`,description:`The nesting level of the tree item, used for indentation.`,table:{type:{summary:`number`}}},expanded:{control:`boolean`,description:`Controls the expanded state of the tree item.`,table:{type:{summary:`boolean`}}},onExpand:{control:`object`,description:`Callback function when the tree item is expanded or collapsed.`,table:{type:{summary:`(id: string, expanded: boolean) => void`}}},icon:{control:`select`,if:{arg:`expandedIcon`,exists:!1},description:`Icon to display next to the tree item label.`,table:{type:{summary:`ReactNode | (expanded: boolean) => ReactNode`}},options:x,mapping:C},children:{control:`select`,description:`The content of the tree item.`,options:[`Text`,`Tag`],mapping:{Text:`This is a tree item`,Tag:(0,E.jsx)(v,{text:`Tag`})},table:{type:{summary:`ReactNode`}}}}}));function k(e,t){let n=new Set(t),r=new Map,i=new Map;for(let t of e){r.set(t.id,t);let e=t.path??[];if(e.length){let n=e[e.length-1];i.has(n)||i.set(n,[]),i.get(n).push(t.id)}}let a={};for(let t of e)(t.isLeaf||!i.has(t.id))&&(a[t.id]=!!n.has(t.id));let o=[...e].sort((e,t)=>(t.path?.length??0)-(e.path?.length??0));for(let e of o){if(e.isLeaf)continue;let t=(i.get(e.id)??[]).map(e=>a[e]);if(t.length===0)a[e.id]=!!n.has(e.id);else{let n=t.every(e=>e===!0),r=t.every(e=>e===!1);n?a[e.id]=!0:r?a[e.id]=!1:a[e.id]=`partial`}}return a}function A({id:e,label:t,onCheck:n,isLeaf:r,path:i,children:a}){let l=(0,N.useContext)(R),u=!0,f=l.selected[e]===`partial`,p=f?!0:!!l.selected[e],g=!!l.expanded[e];return l&&i&&(g=!!l?.expanded?.[e],u=i.every(e=>!!l?.expanded?.[e])),u?(0,P.jsx)(m.Item,{interactive:!0,onClick:()=>{l.onExpand?.(e,!g)},selected:p,children:(0,P.jsxs)(`div`,{className:d(`flex`,`flex-row`,`w-full`,`pl-l`,`pr-l`,`items-center`,`overflow-hidden`),children:[(0,P.jsx)(`div`,{className:d(`flex`,`w-fit`),children:(0,P.jsx)(o,{"aria-label":t,indeterminate:f,checked:p,onChange:t=>{n({id:e,checked:!p})}})}),(0,P.jsx)(h.TreeItem,{id:e,label:t,path:i,isLeaf:r,expanded:g,onExpand:()=>{l.onExpand?.(e,!g)},displayFolderIcon:!r,icon:r?(0,P.jsx)(s,{}):(0,P.jsx)(c,{}),children:a})]})}):null}function j(e,t,n,r){let i=new Map,a=new Map;for(let t of e){i.set(t.id,t);let e=t.path??[];if(e.length){let n=e[e.length-1];a.has(n)||a.set(n,[]),a.get(n).push(t.id)}}function o(e){let t=a.get(e)??[],n=[...t];for(let e of t)n.push(...o(e));return n}let s=new Set(t);if(!i.get(n))return t;let c=[n,...o(n)];if(r)for(let e of c)s.add(e);else for(let e of c)s.delete(e);return[...s]}function M({row:e}){let t=(0,N.useContext)(R),n=!!t.expanded[e.id];return(0,P.jsx)(`div`,{className:d(`flex`,`flex-row`,`w-full`,`pl-l`,`pr-l`,`items-center`,`overflow-hidden`),onClick:()=>{t.onExpand?.(e.id,!n)},children:(0,P.jsx)(h.TreeItem,{onExpand:t.onExpand,expanded:n,id:e.id,displayFolderIcon:!e.isLeaf,label:e.label,isLeaf:e.isLeaf,path:e.path,icon:e.isLeaf?(0,P.jsx)(s,{}):(0,P.jsx)(c,{})})})}var N,P,F,I,L,R,z,B,V,H,U,W,G,K=t((()=>{N=e(n()),i(),_(),T(),y(),O(),P=b(),F={title:`Components/Tree`},I={render:e=>(0,P.jsx)(h.TreeItem,{...e}),args:{id:`treeitem`,label:`TreeItem`},argTypes:D},L={render:()=>(0,P.jsxs)(`div`,{children:[(0,P.jsx)(`h1`,{className:r.classNames(`text-default`,`font-heading-m`),children:`TreeItem alone`}),(0,P.jsx)(h.TreeItem,{id:`simple`,label:`Simple`}),(0,P.jsx)(h.TreeItem,{id:`simple`,label:`Simple`,disabled:!0}),(0,P.jsx)(h.TreeItem,{id:`expanded`,label:`Expanded`,expanded:!0}),(0,P.jsx)(h.TreeItem,{id:`expanded-child`,path:[`expanded`],label:`Expanded child`}),(0,P.jsx)(h.TreeItem,{id:`folder`,label:`folder`,icon:(0,P.jsx)(c,{})}),(0,P.jsx)(h.TreeItem,{id:`folder_expanded`,label:`folder expanded`,displayFolderIcon:!0,expanded:!0}),(0,P.jsx)(h.TreeItem,{id:`leaf`,path:[`folder_expanded`],label:`Leaf`,isLeaf:!0}),(0,P.jsx)(h.TreeItem,{id:`leaf-icon`,path:[`folder_expanded`],label:`Leaf icon`,isLeaf:!0,icon:(0,P.jsx)(s,{})}),(0,P.jsxs)(m,{hasPadding:!1,children:[(0,P.jsx)(m.Item,{interactive:!0,children:(0,P.jsx)(h.TreeItem,{id:`context_simple`,label:`Simple`})}),(0,P.jsx)(m.Item,{interactive:!0,children:(0,P.jsx)(h.TreeItem,{id:`context_expanded`,label:`Expanded`})}),(0,P.jsx)(m.Item,{interactive:!0,children:(0,P.jsx)(h.TreeItem,{id:`context_folder`,label:`folder`,displayFolderIcon:!0})}),(0,P.jsx)(m.Item,{interactive:!0,children:(0,P.jsx)(h.TreeItem,{id:`context_folder_child`,path:[`context_folder`],label:`child`,isLeaf:!0})}),(0,P.jsx)(m.Item,{interactive:!0,children:(0,P.jsx)(h.TreeItem,{id:`context_folder_expanded`,label:`folder expanded`,displayFolderIcon:!0})}),(0,P.jsx)(m.Item,{interactive:!0,children:(0,P.jsx)(h.TreeItem,{id:`context_leaf`,path:[`context_folder_expanded`],label:`Leaf`,isLeaf:!0})}),(0,P.jsx)(m.Item,{interactive:!0,children:(0,P.jsx)(h.TreeItem,{id:`context_leaf-icon`,path:[`context_folder_expanded`],label:`Leaf icon`,isLeaf:!0,icon:(0,P.jsx)(s,{})})})]})]})},R=(0,N.createContext)({expanded:{},selected:{},onExpand:()=>{}}),z=[{id:`folder1`,label:`Folder with 1 folder and 2 files`},{id:`folder1.1`,label:`Folder with 1 files`,path:[`folder1`]},{id:`item1`,label:`File 1`,path:[`folder1`,`folder1.1`],isLeaf:!0},{id:`item2`,label:`File 2`,path:[`folder1`],isLeaf:!0},{id:`item3`,label:`File  3`,path:[`folder1`],isLeaf:!0},{id:`folder2`,label:`Empty folder`,children:(0,P.jsxs)(`div`,{className:d(`flex`,`flex-row`,`items-center`,`justify-end`,`w-full`),children:[(0,P.jsx)(p,{variant:`quiet`,icon:(0,P.jsx)(g,{}),"aria-label":`Copy`}),(0,P.jsx)(p,{variant:`quiet`,icon:(0,P.jsx)(l,{}),"aria-label":`Edit`})]})},{id:`item4`,label:`Orphan file`,isLeaf:!0,children:(0,P.jsx)(v,{text:`Tag`})},{id:`item5`,label:`Orphan file`,isLeaf:!0,children:(0,P.jsx)(f,{color:`info`})},{id:`item6`,label:`Orphan file`,isLeaf:!0,children:(0,P.jsx)(u,{title:`I'm a tooltip`,children:(0,P.jsx)(`button`,{type:`button`,className:d(`flex`,`p-xs`,`m-xs`,`border-box`,`border-none`,`bg-transparent`,`cursor-pointer`,`radius-round`,`outline-focus-visible-centered`),children:(0,P.jsx)(a,{})})})},{id:`item7`,label:`a-cron-long-long-long-long-long-long-long-long-long-long-long-long-long-long-long-long (V2)`,isLeaf:!0}],B={parameters:{chromatic:{disableSnapshot:!0}},render:()=>{let[e,t]=(0,N.useState)({item4:!0}),[n,r]=(0,N.useState)({}),i=n=>{let r=Object.keys(e).filter(t=>e[t]===!0),i=j(z,r,n.id,n.checked),a=k(z,i);t(a)};return(0,P.jsx)(`div`,{className:d(`flex`,`w-m`),children:(0,P.jsx)(m,{hasPadding:!1,children:(0,P.jsx)(R.Provider,{value:{expanded:n,selected:e,onExpand:(e,t)=>{r(n=>({...n,[e]:t}))}},children:z.map(e=>(0,P.jsx)(A,{id:e.id,path:e.path,isLeaf:e.isLeaf,label:e.label,onCheck:i,children:e.children},e.id))})})})}},V=[{id:`folder1`,label:`FirstFolderWithAReallyLongNameThatExceedsTheLimitAtSomePoint with 1 folder and 2 files`},{id:`folder1.1`,label:`SecondFolderWithAReallyLongNameThatExceedsTheLimitAtSomePoint with 1 files and 1 folder`,path:[`folder1`]},{id:`folder1.1.1`,label:`ThirdFolderWithAReallyLongNameThatExceedsTheLimitAtSomePoint without files`,path:[`folder1`,`folder1.1`]},{id:`item1`,label:`File 1`,path:[`folder1`,`folder1.1`],isLeaf:!0},{id:`item2`,label:`File 2`,path:[`folder1`],isLeaf:!0},{id:`item3`,label:`File  3`,path:[`folder1`],isLeaf:!0},{id:`folder2`,label:`Empty folder`},{id:`item4`,label:`Orphan file`,isLeaf:!0}],H={parameters:{chromatic:{disableSnapshot:!0}},render:()=>{let[e,t]=(0,N.useState)({}),[n,r]=(0,N.useState)({folder1:!0,"folder1.1":!0}),i=n=>{let r=Object.keys(e).filter(t=>e[t]===!0),i=j(V,r,n.id,n.checked),a=k(V,i);t(a)};return(0,P.jsx)(`div`,{className:d(`flex`,`w-m`,`border-weak`,`overflow-auto`),children:(0,P.jsx)(m,{hasPadding:!1,children:(0,P.jsx)(R.Provider,{value:{expanded:n,selected:e,onExpand:(e,t)=>{r(n=>({...n,[e]:t}))}},children:V.map(e=>(0,P.jsx)(A,{id:e.id,path:e.path,isLeaf:e.isLeaf,label:e.label,onCheck:i},e.id))})})})}},U=[{field:`label`,headerName:`Name`,width:300,renderCell:e=>(0,P.jsx)(M,{row:e.row})},{field:`path`,headerName:`Path`,flex:1,renderCell:e=>(e.row.path||[]).join(` / `)}],W={parameters:{chromatic:{disableSnapshot:!0}},render:()=>{let[e,t]=(0,N.useState)({}),n=(0,N.useMemo)(()=>z.filter(t=>!t.path||t.path.every(t=>!!e[t])),[e,z]);return(0,P.jsxs)(`div`,{className:d(`border-weak`,`w-l`),children:[(0,P.jsx)(R.Provider,{value:{expanded:e,selected:{},onExpand:(n,r)=>{t({...e,[n]:r})}},children:(0,P.jsx)(w,{variant:`list`,rows:n,columns:U,rowHeight:40})}),(0,P.jsx)(`pre`,{children:JSON.stringify(e,null,2)})]})}},I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
