...
`,(0,c.jsxs)(n.li,{children:[`When setting up a Storybook instance (though we recommend using `,(0,c.jsx)(n.code,{children:`@qlik/sprout-css-storybook`}),` for this purpose).`]}),`
`]}),`
...
`,(0,c.jsxs)(n.p,{children:[`Setting up Sprout CSS in Storybook is straightforward. You can use the `,(0,c.jsx)(n.code,{children:`@qlik/sprout-css-storybook`}),` package to simplify the process.`]}),`
